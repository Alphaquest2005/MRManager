    ...
    public class MainWindowViewModel : ViewModelBase<MainWindowViewModel>
    {
        ...
        public MainWindowViewModel()
        {
			this.navAllocationQS = new RelayCommand(OnNavAllocationQS);
				...
				this.navOversShortQS = new RelayCommand(OnNavOversShortQS);
		...
		public ICommand NavSalesDataQS
        {
			...
			private RelayCommand navOversShortQS;
        private void OnNavOversShortQS()
        {
            Core.Common.UI.BaseViewModel.Slider.MoveTo("OversShortQSEXP"); 
        }

		public ICommand NavOversShortQS
        {
            get { return this.navOversShortQS; }
        }
