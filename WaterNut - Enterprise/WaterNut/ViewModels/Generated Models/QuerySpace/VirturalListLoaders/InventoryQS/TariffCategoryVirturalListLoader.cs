...
{
    public partial class TariffCategoryVirturalListLoader : IVirtualListLoader<TariffCategory>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.TariffCategoryFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.TariffCategoryFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<TariffCategory> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
