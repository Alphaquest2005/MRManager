...
{
    public partial class OversShortVirturalListLoader : IVirtualListLoader<OversShort>
	{
        ...
        public IList<OversShort> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
