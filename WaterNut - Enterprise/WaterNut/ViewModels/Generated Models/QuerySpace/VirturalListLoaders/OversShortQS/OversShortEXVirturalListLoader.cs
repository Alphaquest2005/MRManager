...
{
    public partial class OversShortEXVirturalListLoader : IVirtualListLoader<OversShortEX>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OversShortsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OversShortsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OversShortEX> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
