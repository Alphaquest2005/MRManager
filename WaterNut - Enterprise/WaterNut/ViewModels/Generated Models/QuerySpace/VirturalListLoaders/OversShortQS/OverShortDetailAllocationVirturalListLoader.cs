...
{
    public partial class OverShortDetailAllocationVirturalListLoader : IVirtualListLoader<OverShortDetailAllocation>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OverShortDetailAllocationsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OverShortDetailAllocationsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OverShortDetailAllocation> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OverShortDetailAllocation>() ;
            }
