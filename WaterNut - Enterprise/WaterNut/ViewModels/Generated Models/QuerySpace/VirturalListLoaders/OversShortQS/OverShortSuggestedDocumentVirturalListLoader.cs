...
{
    public partial class OverShortSuggestedDocumentVirturalListLoader : IVirtualListLoader<OverShortSuggestedDocument>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.OverShortSuggestedDocumentsFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.OverShortSuggestedDocumentsFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<OverShortSuggestedDocument> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<OverShortSuggestedDocument>() ;
            }
