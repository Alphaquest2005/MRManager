...
{
    public partial class ContainerEntryDataVirturalListLoader : IVirtualListLoader<ContainerEntryData>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.ContainerEntryDatasFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.ContainerEntryDatasFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<ContainerEntryData> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                overallCount = 0;
                return new List<ContainerEntryData>() ;
            }
