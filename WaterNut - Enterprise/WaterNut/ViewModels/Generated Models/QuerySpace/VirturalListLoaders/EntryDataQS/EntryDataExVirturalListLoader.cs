...
{
    public partial class EntryDataExVirturalListLoader : IVirtualListLoader<EntryDataEx>
	{
        ...
        public string FilterExpression
        {
            ...
            set
            {
                ...
                MessageBus.Default.BeginNotify(MessageToken.EntryDataExFilterExpressionChanged, null,
                                            new NotificationEventArgs<string>(MessageToken.EntryDataExFilterExpressionChanged, _filterExpression));
            }
        }
        ...
        public IList<EntryDataEx> LoadRange(int startIndex, int count, SortDescriptionCollection sortDescriptions, out int overallCount)
        {
            try
            {
