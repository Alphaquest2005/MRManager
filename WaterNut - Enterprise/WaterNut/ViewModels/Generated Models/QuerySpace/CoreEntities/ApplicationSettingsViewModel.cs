...
// Filtering Each Field except IDs
		...
		private string _allowWeightEqualQuantityFilter;
        public string AllowWeightEqualQuantityFilter
        {
            get
            {
                return _allowWeightEqualQuantityFilter;
            }
            set
            {
                _allowWeightEqualQuantityFilter = value;
				NotifyPropertyChanged(x => AllowWeightEqualQuantityFilter);
                FilterData();
					...
					if (Convert.ToDateTime(_openingStockDateFilter).Date != DateTime.MinValue)
						{
							if(OpeningStockDateFilter.HasValue)
								res.Append(" && " + string.Format("OpeningStockDate == \"{0}\"",  Convert.ToDateTime(OpeningStockDateFilter).Date.ToString("MM/dd/yyyy")));
									...
									if(string.IsNullOrEmpty(AllowWeightEqualQuantityFilter) == false)
						res.Append(" && " + string.Format("AllowWeightEqualQuantity.Contains(\"{0}\")",  AllowWeightEqualQuantityFilter));						
...
// Send to Excel Implementation
        ...
        public class ApplicationSettingsExcelLine
        {
                    ...
                    public string AllowWeightEqualQuantity { get; set; } 
