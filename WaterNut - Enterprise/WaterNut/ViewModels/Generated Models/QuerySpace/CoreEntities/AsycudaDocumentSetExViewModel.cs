...
// Filtering Each Field except IDs
		...
		private Int32? _apportionMethodFilter;
        public Int32? ApportionMethodFilter
        {
            get
            {
		...
		var res = new StringBuilder();
		        ...
		        Convert.ToDateTime(EndEntryTimeStampFilter).Date != DateTime.MinValue) res.Append(" )");
					...
					if(TotalGrossWeightFilter.HasValue)
						res.Append(" && " + string.Format("TotalGrossWeight == {0}",  TotalGrossWeightFilter.ToString()));							return res.ToString().StartsWith(" &&") || res.Length == 0 ? res:  res.Insert(0," && ");		
		}
...
// Send to Excel Implementation
        ...
        public class AsycudaDocumentSetExExcelLine
        {
                    ...
                    public Nullable<int> ApportionMethod { get; set; } 
