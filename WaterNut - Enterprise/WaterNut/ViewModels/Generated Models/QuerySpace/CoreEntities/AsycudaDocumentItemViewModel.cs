...
// Filtering Each Field except IDs
		 ...
		 bool _viewCurrentAsycudaDocument = true;
		...
		private DateTime? _startRegistrationDateFilter = DateTime.MinValue;//DateTime.Parse(string.Format("{0}/1/{1}", DateTime.Now.Month ,DateTime.Now.Year));
		...
		private DateTime? _endRegistrationDateFilter = DateTime.MinValue;//DateTime.Parse(string.Format("{1}/{0}/{2}", DateTime.DaysInMonth( DateTime.Now.Year,DateTime.Now.Month), DateTime.Now.Month, DateTime.Now.Year));
