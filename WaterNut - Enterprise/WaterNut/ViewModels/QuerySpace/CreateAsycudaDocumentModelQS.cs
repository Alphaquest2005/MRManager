...
namespace WaterNut.QuerySpace.CoreEntities.ViewModels
{
    public class CreateAsycudaDocumentModel : ViewModelBase<CreateAsycudaDocumentModel>, IAsyncInitialization
	{
       ...
       public static CreateAsycudaDocumentModel Instance
        ...
        public double _TotalGrossWeight;
        ...
        internal async Task NewDocumentSet()
        {
           var docSet = await AsycudaDocumentSetExRepository.Instance.NewDocumentSet().ConfigureAwait(false);
