             ...
             var res = GetAutoPropertyFilterString();
              ...
              if (ViewDocData == true)
              {
                  if (CoreEntities.ViewModels.BaseViewModel.Instance.CurrentAsycudaDocumentSetEx != null)
                  {
                      ...
                      vloader.SetNavigationExpression("AsycudaDocumentSets", string.Format(@"AsycudaDocumentSetId == {0}", CoreEntities.ViewModels.BaseViewModel.Instance.CurrentAsycudaDocumentSetEx.AsycudaDocumentSetId));
