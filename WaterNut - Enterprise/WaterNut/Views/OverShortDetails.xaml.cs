...
namespace WaterNut.Views
{
	...
	/// </summary>
    public partial class OverShortDetailsView : UserControl
	{
        public OverShortDetailsView()
		{
			this.InitializeComponent();
            im = TryFindResource("OverShortDetailsModelDataSource") as OverShortDetailsModel;
