...
namespace WaterNut.Views
{
	...
	public partial class Allocations : UserControl
	{
        ...
        private void ListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            im.SelectedAsycudaSalesAllocationsExs = new ObservableCollection<AsycudaSalesAllocationsEx>(ItemLst.SelectedItems.OfType<AsycudaSalesAllocationsEx>());
        }
        ...
        private async void Grid_Drop(object sender, DragEventArgs e)
        {
            if (e.Data.GetDataPresent("xcuda_Item_Format"))
            {
                ...
                var callo = ((VirtualListItem<AsycudaSalesAllocationsEx>)((FrameworkElement)sender).DataContext).Data;
