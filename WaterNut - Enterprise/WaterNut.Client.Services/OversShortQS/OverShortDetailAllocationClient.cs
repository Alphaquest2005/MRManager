...
{
    [Export (typeof(OverShortDetailAllocationClient))]
    ...
    public partial class OverShortDetailAllocationClient :  ClientService<IOverShortDetailAllocationService>, IOverShortDetailAllocationService, IDisposable
    {
        ...
        {
            return await Channel.GetOverShortDetailAllocationsByBatch(exp, totalrow, includesLst).ConfigureAwait(false);
        }
        ...
        {
            return await Channel.DeleteOverShortDetailAllocation(id).ConfigureAwait(false);
        }
