...
namespace EntryDataQS.Client.Services
{
    ...
    public partial class AsycudaDocumentEntryDataClient :  ClientService<IAsycudaDocumentEntryDataService>, IAsycudaDocumentEntryDataService, IDisposable
    {
        ...
        public async Task<IEnumerable<DTO.AsycudaDocumentEntryData>> GetAsycudaDocumentEntryDatas(List<string> includesLst = null)
        {
		...
		public async Task<IEnumerable<DTO.AsycudaDocumentEntryData>> GetAsycudaDocumentEntryDatasByExpression(string exp, List<string> includesLst = null)
        {
            return await Channel.GetAsycudaDocumentEntryDatasByExpression(exp, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<DTO.AsycudaDocumentEntryData>> GetAsycudaDocumentEntryDatasByExpressionLst(List<string> expLst, List<string> includesLst = null)
        {
            return await Channel.GetAsycudaDocumentEntryDatasByExpressionLst(expLst, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<DTO.AsycudaDocumentEntryData>> GetAsycudaDocumentEntryDatasByExpressionNav(string exp,
