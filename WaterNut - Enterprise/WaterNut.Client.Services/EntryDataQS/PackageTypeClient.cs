...
{
    [Export (typeof(PackageTypeClient))]
    ...
    public partial class PackageTypeClient :  ClientService<IPackageTypeService>, IPackageTypeService, IDisposable
    {
        ...
        {
            return await Channel.GetPackageTypesByBatch(exp, totalrow, includesLst).ConfigureAwait(false);
        }
        ...
        {
            return await Channel.DeletePackageType(id).ConfigureAwait(false);
        }
