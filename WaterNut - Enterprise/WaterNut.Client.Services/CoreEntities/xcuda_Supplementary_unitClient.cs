...
namespace CoreEntities.Client.Services
{
    ...
    public partial class xcuda_Supplementary_unitClient :  ClientService<Ixcuda_Supplementary_unitService>, Ixcuda_Supplementary_unitService, IDisposable
    {
        ...
        public async Task<IEnumerable<DTO.xcuda_Supplementary_unit>> Getxcuda_Supplementary_unit(List<string> includesLst = null)
        {
            return await Channel.Getxcuda_Supplementary_unit(includesLst).ConfigureAwait(false);
        }

        public async Task<DTO.xcuda_Supplementary_unit> Getxcuda_Supplementary_unitByKey(string id, List<string> includesLst = null)
        {
            return await Channel.Getxcuda_Supplementary_unitByKey(id, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<DTO.xcuda_Supplementary_unit>> Getxcuda_Supplementary_unitByExpression(string exp, List<string> includesLst = null)
        {
            return await Channel.Getxcuda_Supplementary_unitByExpression(exp, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<DTO.xcuda_Supplementary_unit>> Getxcuda_Supplementary_unitByExpressionLst(List<string> expLst, List<string> includesLst = null)
        {
            return await Channel.Getxcuda_Supplementary_unitByExpressionLst(expLst, includesLst).ConfigureAwait(false);
        }

		public async Task<IEnumerable<DTO.xcuda_Supplementary_unit>> Getxcuda_Supplementary_unitByExpressionNav(string exp,
        ...
        public async Task<DTO.xcuda_Supplementary_unit> Updatexcuda_Supplementary_unit(DTO.xcuda_Supplementary_unit entity)
        {
           return await Channel.Updatexcuda_Supplementary_unit(entity).ConfigureAwait(false);
        }

        public async Task<DTO.xcuda_Supplementary_unit> Createxcuda_Supplementary_unit(DTO.xcuda_Supplementary_unit entity)
        {
       ...
       // Virtural List implementation
        ...
        public async Task<IEnumerable<DTO.xcuda_Supplementary_unit>> LoadRange(int startIndex, int count, string exp)
        {
            return await Channel.LoadRange(startIndex,count,exp).ConfigureAwait(false);
        }

		public async Task<IEnumerable<DTO.xcuda_Supplementary_unit>>  LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            return await Channel.LoadRangeNav(startIndex,count,exp, navExp, includeLst).ConfigureAwait(false);
        }
		public async Task<IEnumerable<DTO.xcuda_Supplementary_unit>> Getxcuda_Supplementary_unitByTarification_Id(string Tarification_Id, List<string> includesLst = null)
        {
