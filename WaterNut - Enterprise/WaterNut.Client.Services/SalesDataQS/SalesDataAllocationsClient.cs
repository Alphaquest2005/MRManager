...
{
    [Export (typeof(SalesDataAllocationsClient))]
    ...
    public partial class SalesDataAllocationsClient :  ClientService<ISalesDataAllocationsService>, ISalesDataAllocationsService, IDisposable
    {
        ...
        {
            return await Channel.GetSalesDataAllocationsByBatch(exp, totalrow, includesLst).ConfigureAwait(false);
        }
        ...
        {
            return await Channel.DeleteSalesDataAllocations(id).ConfigureAwait(false);
        }
