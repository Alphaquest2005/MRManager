...
namespace SalesDataQS.Client.Services
{
    ...
    public partial class SalesDataClient :  ClientService<ISalesDataService>, ISalesDataService, IDisposable
    {
        ...
        {
            return await Channel.GetSalesDatasByBatch(exp, totalrow, includesLst).ConfigureAwait(false);
        }
        ...
        {
            return await Channel.DeleteSalesData(id).ConfigureAwait(false);
        }
