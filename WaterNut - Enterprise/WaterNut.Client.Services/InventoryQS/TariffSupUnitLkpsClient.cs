...
{
    [Export (typeof(TariffSupUnitLkpsClient))]
    ...
    public partial class TariffSupUnitLkpsClient :  ClientService<ITariffSupUnitLkpsService>, ITariffSupUnitLkpsService, IDisposable
    {
        ...
        {
            return await Channel.GetTariffSupUnitLkpsByBatch(exp, totalrow, includesLst).ConfigureAwait(false);
        }
        ...
        {
            return await Channel.DeleteTariffSupUnitLkps(id).ConfigureAwait(false);
        }
