...
namespace OversShortQS.Client.Repositories 
{
    ...
    public partial class OverShortDetailsEXRepository : BaseRepository<OverShortDetailsEXRepository>
    {
       ...
       private static readonly OverShortDetailsEXRepository instance;
       static OverShortDetailsEXRepository()
        {
            instance = new OverShortDetailsEXRepository();
        }

       public static OverShortDetailsEXRepository Instance
        {
            get { return instance; }
        }
        ...
        {
            if (System.ComponentModel.LicenseManager.UsageMode == LicenseUsageMode.Designtime) return new List<OverShortDetailsEX>().AsEnumerable();
            try
            {
		 ...
		 public async Task<IEnumerable<OverShortDetailsEX>> GetOverShortDetailsByExpression(string exp, List<string> includesLst = null)
        {
            if (System.ComponentModel.LicenseManager.UsageMode == LicenseUsageMode.Designtime || exp == null || exp == "None") return new List<OverShortDetailsEX>().AsEnumerable();
            try
            {
                using (var t = new OverShortDetailsEXClient())
                    {
		 ...
		 public async Task<IEnumerable<OverShortDetailsEX>> GetOverShortDetailsByExpressionLst(List<string> expLst, List<string> includesLst = null)
        {
            if (System.ComponentModel.LicenseManager.UsageMode == LicenseUsageMode.Designtime || expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<OverShortDetailsEX>().AsEnumerable();
            try
            {
                using (var t = new OverShortDetailsEXClient())
                    {
