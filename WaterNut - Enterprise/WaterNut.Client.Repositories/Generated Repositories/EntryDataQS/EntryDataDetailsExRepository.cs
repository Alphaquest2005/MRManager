...
using EntryDataDetailsEx = EntryDataQS.Client.Entities.EntryDataDetailsEx;
...
namespace EntryDataQS.Client.Repositories 
{
    ...
    public partial class EntryDataDetailsExRepository : BaseRepository<EntryDataDetailsExRepository>
    {
       ...
       public static EntryDataDetailsExRepository Instance
        ...
        public async Task<IEnumerable<EntryDataDetailsEx>> EntryDataDetailsExes(List<string> includesLst = null)
        {
            ...
            try
            {
                using (var t = new EntryDataDetailsExClient())
                    {
                        var res = await t.GetEntryDataDetailsExes(includesLst).ConfigureAwait(continueOnCapturedContext: false);
                        if (res != null)
                        {
                ...
                using (var t = new EntryDataDetailsExClient())
                    {
                        ...
                        if(exp == "All")
                        {                       
						    res = await t.GetEntryDataDetailsExes(includesLst).ConfigureAwait(continueOnCapturedContext: false);					
                        }
                        else
                        {
                             res = await t.GetEntryDataDetailsExesByExpression(exp, includesLst).ConfigureAwait(continueOnCapturedContext: false);	                         
                        }
		 ...
		 public async Task<IEnumerable<EntryDataDetailsEx>> GetEntryDataDetailsExesByExpressionLst(List<string> expLst, List<string> includesLst = null)
        {
                ...
                using (var t = new EntryDataDetailsExClient())
                    {
                        ...
                        res = await t.GetEntryDataDetailsExesByExpressionLst(expLst, includesLst).ConfigureAwait(continueOnCapturedContext: false);	                         
		 ...
		 public async Task<IEnumerable<EntryDataDetailsEx>> GetEntryDataDetailsExesByExpressionNav(string exp, Dictionary<string, string> navExp, List<string> includesLst = null)
        {
            if (System.ComponentModel.LicenseManager.UsageMode == LicenseUsageMode.Designtime || exp == null || exp == "None") return new List<EntryDataDetailsEx>().AsEnumerable();
            try
            {
                using (var t = new EntryDataDetailsExClient())
                    {
                        ...
                        {
                             res = await t.GetEntryDataDetailsExesByExpressionNav(exp, navExp, includesLst).ConfigureAwait(continueOnCapturedContext: false);	                         
                        }
