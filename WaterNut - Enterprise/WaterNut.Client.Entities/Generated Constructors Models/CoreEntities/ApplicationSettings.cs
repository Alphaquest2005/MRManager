...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class ApplicationSettings 
    {
       public ApplicationSettings()
        {
            this.DTO = new DTO.ApplicationSettings();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.ApplicationSettings>(this.DTO);
