...
namespace CoreEntities.Client.Entities
{
    ...
    public partial class Customs_Procedure 
    {
       public Customs_Procedure()
        {
            this.DTO = new DTO.Customs_Procedure();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.Customs_Procedure>(this.DTO);
