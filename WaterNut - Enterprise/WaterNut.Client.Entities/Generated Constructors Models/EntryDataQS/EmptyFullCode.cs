...
namespace EntryDataQS.Client.Entities
{
    ...
    {
       public EmptyFullCode()
        {
            this.DTO = new DTO.EmptyFullCode();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.EmptyFullCode>(this.DTO);
