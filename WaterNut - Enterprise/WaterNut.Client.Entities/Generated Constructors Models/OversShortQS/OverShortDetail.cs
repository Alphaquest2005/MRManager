...
namespace OversShortQS.Client.Entities
{
    ...
    public partial class OverShortDetail 
    {
       public OverShortDetail()
        {
            this.DTO = new DTO.OverShortDetail();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OverShortDetail>(this.DTO);
