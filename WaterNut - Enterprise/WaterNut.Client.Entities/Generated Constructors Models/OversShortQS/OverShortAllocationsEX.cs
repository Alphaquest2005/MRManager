...
namespace OversShortQS.Client.Entities
{
    ...
    {
       public OverShortAllocationsEX()
        {
            this.DTO = new DTO.OverShortAllocationsEX();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OverShortAllocationsEX>(this.DTO);
