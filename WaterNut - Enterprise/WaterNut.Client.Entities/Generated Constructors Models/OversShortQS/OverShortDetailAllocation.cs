...
namespace OversShortQS.Client.Entities
{
    ...
    {
       public OverShortDetailAllocation()
        {
            this.DTO = new DTO.OverShortDetailAllocation();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OverShortDetailAllocation>(this.DTO);
