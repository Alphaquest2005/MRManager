...
namespace OversShortQS.Client.Entities
{
    ...
    public partial class OverShortDetailsEX 
    {
       public OverShortDetailsEX()
        {
            this.DTO = new DTO.OverShortDetailsEX();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.OverShortDetailsEX>(this.DTO);
