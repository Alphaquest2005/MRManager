...
namespace CounterPointQS.Client.Entities
{
    ...
    public partial class CounterPointPODetails 
    {
       public CounterPointPODetails()
        {
            this.DTO = new DTO.CounterPointPODetails();//{TrackingState = TrackableEntities.TrackingState.Added}
            _changeTracker = new ChangeTrackingCollection<DTO.CounterPointPODetails>(this.DTO);
