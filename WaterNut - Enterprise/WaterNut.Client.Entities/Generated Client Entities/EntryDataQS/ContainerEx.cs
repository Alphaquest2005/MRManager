...
public string Container_identity
		{ 
			...
			set
			{
                ...
                [MaxLength(10, ErrorMessage = "Container_type has a max length of 10 letters ")]
...
public string Packages_number
		{ 
			...
			set
			{
                ...
                [MaxLength(10, ErrorMessage = "Packages_type has a max length of 10 letters ")]
...
public Nullable<System.DateTime> DeliveryDate
		{ 
			...
			set
			{
                ...
                [MaxLength(50, ErrorMessage = "Seal has a max length of 50 letters ")]
public string Seal
		{ 
