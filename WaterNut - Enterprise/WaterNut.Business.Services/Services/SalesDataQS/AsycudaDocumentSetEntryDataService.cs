    ...
    public partial class AsycudaDocumentSetEntryDataService : IAsycudaDocumentSetEntryDataService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "SalesData":
                                return
                                    await
                                        GetWhere<SalesData>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<AsycudaDocumentSetEntryData> CreateAsycudaDocumentSetEntryData(AsycudaDocumentSetEntryData entity)
        {
            try
            {
                using ( var dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
              {
                dbContext.AsycudaDocumentSetEntryData.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> DeleteAsycudaDocumentSetEntryData(string Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(Id);
                AsycudaDocumentSetEntryData entity = await dbContext.AsycudaDocumentSetEntryData
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (SalesDataQSContext dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.AsycudaDocumentSetEntryData
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
            ...
            try
            {
                ...
                using (var dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "SalesData":
                                return await CountWhere<SalesData>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return await dbContext.AsycudaDocumentSetEntryData.Where(exp == "All" || exp == null ? "Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "SalesData":
                                return
                                    await
                                        LoadRangeWhere<SalesData>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.AsycudaDocumentSetEntryData
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "Id != null" : exp)
								.OrderBy(y => y.Id)
        ...
        private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhere<T>(SalesDataQSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelectMany<T>(SalesDataQSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelect<T>(SalesDataQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetAsycudaDocumentSetEntryDataByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<AsycudaDocumentSetEntryData> entities = await set//dbContext.AsycudaDocumentSetEntryData
                                      .AsNoTracking()
            ...
            try
            {
                ...
                using (var dbContext = new SalesDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "SalesData":
                                return await SumWhere<SalesData>(dbContext, exp, itm.Value, "AsycudaDocumentSets", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<AsycudaDocumentSetEntryData> AddIncludes(IEnumerable<string> includesLst, SalesDataQSContext dbContext)
       {
		 try
			{
