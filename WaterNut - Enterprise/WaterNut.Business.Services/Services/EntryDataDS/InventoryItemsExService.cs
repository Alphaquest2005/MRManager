    ...
    public partial class InventoryItemsExService : IInventoryItemsExService, IDisposable
    {
        ...
        public async Task<InventoryItemsEx> CreateInventoryItemsEx(InventoryItemsEx entity)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                dbContext.InventoryItemsEx.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        private static async Task<IEnumerable<InventoryItemsEx>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItemsEx>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItemsEx>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<InventoryItemsEx> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
