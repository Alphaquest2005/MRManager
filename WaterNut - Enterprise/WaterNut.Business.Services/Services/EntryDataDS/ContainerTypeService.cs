    ...
    public partial class ContainerTypeService : IContainerTypeService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "Container":
                                return
                                    await
                                        GetWhere<Container>(dbContext, exp, itm.Value, "ContainerTypes", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<ContainerType> CreateContainerType(ContainerType entity)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
              {
                dbContext.ContainerTypes.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "Container":
                                return await CountWhere<Container>(dbContext, exp, itm.Value, "ContainerTypes", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "Container":
                                return
                                    await
                                        LoadRangeWhere<Container>(startIndex, count, dbContext, exp, itm.Value, "ContainerTypes", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<ContainerType>> GetWhere<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<ContainerType>> GetWhereSelectMany<T>(EntryDataDSContext dbContext,
		...
		private static async Task<IEnumerable<ContainerType>> GetWhereSelect<T>(EntryDataDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "Container":
                                return await SumWhere<Container>(dbContext, exp, itm.Value, "ContainerTypes", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<ContainerType> AddIncludes(IEnumerable<string> includesLst, EntryDataDSContext dbContext)
       {
		 try
			{
