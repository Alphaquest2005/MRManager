    ...
    public partial class PurchaseOrdersService : IPurchaseOrdersService, IDisposable
    {
        ...
        public async Task<PurchaseOrders> CreatePurchaseOrders(PurchaseOrders entity)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
                {
                    var ep = dbContext.Set<PurchaseOrders>().Find(entity.EntityId);
                    if (ep == null)
                    {
                        dbContext.Set<PurchaseOrders>().Add(entity);
                    }
                    else
                    {
                        dbContext.Set<PurchaseOrders>().Remove(ep);
                        dbContext.Set<PurchaseOrders>().Add(entity);
                    }
            ...
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			catch (Exception)
			{
				...
				throw;
			        ...
			        public async Task<IEnumerable<PurchaseOrders>> GetPurchaseOrdersBySupplierId(string SupplierId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new EntryDataDSContext(){StartTracking = StartTracking})
