...
namespace InventoryQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TariffSupUnitLkpsService : ITariffSupUnitLkpsService, IDisposable
    {
        ...
        private static async Task<IEnumerable<TariffSupUnitLkps>> GetWhere<T>(InventoryQSContext dbContext,
		...
		private static IQueryable<TariffSupUnitLkps> AddIncludes(IEnumerable<string> includesLst, InventoryQSContext dbContext)
       {
		 try
			{
