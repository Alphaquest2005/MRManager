...
namespace InventoryQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class TariffCodesService : ITariffCodesService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "InventoryItemsEx":
                                return
                                    await
                                        GetWhere<InventoryItemsEx>(dbContext, exp, itm.Value, "TariffCodes", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
                        ...
                        switch (itm.Key)
                        {
                            case "TariffCategory":
                                return await CountWhere<TariffCategory>(dbContext, exp, itm.Value, "TariffCodes", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryItemsEx":
                                return await CountWhere<InventoryItemsEx>(dbContext, exp, itm.Value, "TariffCodes", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "InventoryItemsEx":
                                return
                                    await
                                        LoadRangeWhere<InventoryItemsEx>(startIndex, count, dbContext, exp, itm.Value, "TariffCodes", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<TariffCodes>> GetWhere<T>(InventoryQSContext dbContext,
		...
		private static async Task<IEnumerable<TariffCodes>> GetWhereSelectMany<T>(InventoryQSContext dbContext,
		...
		private static async Task<IEnumerable<TariffCodes>> GetWhereSelect<T>(InventoryQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
                        ...
                        switch (itm.Key)
                        {
                            case "TariffCategory":
                                return await SumWhere<TariffCategory>(dbContext, exp, itm.Value, "TariffCodes", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryItemsEx":
                                return await SumWhere<InventoryItemsEx>(dbContext, exp, itm.Value, "TariffCodes", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<TariffCodes> AddIncludes(IEnumerable<string> includesLst, InventoryQSContext dbContext)
       {
		 try
			{
