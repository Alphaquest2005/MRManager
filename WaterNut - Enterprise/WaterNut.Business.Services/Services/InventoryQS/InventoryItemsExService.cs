...
namespace InventoryQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemsExService : IInventoryItemsExService, IDisposable
    {
        ...
        private static async Task<IEnumerable<InventoryItemsEx>> GetWhere<T>(InventoryQSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItemsEx>> GetWhereSelectMany<T>(InventoryQSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItemsEx>> GetWhereSelect<T>(InventoryQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<InventoryItemsEx> AddIncludes(IEnumerable<string> includesLst, InventoryQSContext dbContext)
       {
		 try
			{
