    ...
    public partial class xcuda_TypeService : Ixcuda_TypeService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<xcuda_Type> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<xcuda_Type> Getxcuda_TypeByKey(string ASYCUDA_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                xcuda_Type entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.ASYCUDA_Id == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<xcuda_Type> Createxcuda_Type(xcuda_Type entity)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                dbContext.xcuda_Type.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> Deletexcuda_Type(string ASYCUDA_Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(ASYCUDA_Id);
                xcuda_Type entity = await dbContext.xcuda_Type
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (DocumentDSContext dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.xcuda_Type
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.xcuda_Type.Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.xcuda_Type
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
								.OrderBy(y => y.ASYCUDA_Id)
