    ...
    public partial class ExportTemplateService : IExportTemplateService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<ExportTemplate> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<ExportTemplate> GetExportTemplateByKey(string ExportTemplateId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                ExportTemplate entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.ExportTemplateId == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<ExportTemplate> CreateExportTemplate(ExportTemplate entity)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                dbContext.ExportTemplates.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> DeleteExportTemplate(string ExportTemplateId)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(ExportTemplateId);
                ExportTemplate entity = await dbContext.ExportTemplates
													.SingleOrDefaultAsync(x => x.ExportTemplateId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (DocumentDSContext dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.ExportTemplates
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.ExportTemplates.Where(exp == "All" || exp == null ? "ExportTemplateId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.ExportTemplates
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "ExportTemplateId != null" : exp)
								.OrderBy(y => y.ExportTemplateId)
