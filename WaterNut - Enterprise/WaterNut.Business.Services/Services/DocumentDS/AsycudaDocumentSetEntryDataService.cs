    ...
    public partial class AsycudaDocumentSetEntryDataService : IAsycudaDocumentSetEntryDataService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocumentSet":
                                return
                                    await
                                        GetWhere<AsycudaDocumentSet>(dbContext, exp, itm.Value, "AsycudaDocumentSetEntryDatas", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<AsycudaDocumentSetEntryData> CreateAsycudaDocumentSetEntryData(AsycudaDocumentSetEntryData entity)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                dbContext.AsycudaDocumentSetEntryDatas.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
            ...
            try
            {
                ...
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocumentSet":
                                return await CountWhere<AsycudaDocumentSet>(dbContext, exp, itm.Value, "AsycudaDocumentSetEntryDatas", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocumentSet":
                                return
                                    await
                                        LoadRangeWhere<AsycudaDocumentSet>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentSetEntryDatas", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhere<T>(DocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelectMany<T>(DocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelect<T>(DocumentDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
            ...
            try
            {
                ...
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocumentSet":
                                return await SumWhere<AsycudaDocumentSet>(dbContext, exp, itm.Value, "AsycudaDocumentSetEntryDatas", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<AsycudaDocumentSetEntryData> AddIncludes(IEnumerable<string> includesLst, DocumentDSContext dbContext)
       {
		 try
			{
