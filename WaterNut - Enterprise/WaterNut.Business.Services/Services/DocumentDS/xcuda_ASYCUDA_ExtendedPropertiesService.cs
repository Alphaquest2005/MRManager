    ...
    public partial class xcuda_ASYCUDA_ExtendedPropertiesService : Ixcuda_ASYCUDA_ExtendedPropertiesService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<xcuda_ASYCUDA_ExtendedProperties> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<xcuda_ASYCUDA_ExtendedProperties> Getxcuda_ASYCUDA_ExtendedPropertiesByKey(string ASYCUDA_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                xcuda_ASYCUDA_ExtendedProperties entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.ASYCUDA_Id == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<xcuda_ASYCUDA_ExtendedProperties> Createxcuda_ASYCUDA_ExtendedProperties(xcuda_ASYCUDA_ExtendedProperties entity)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                dbContext.xcuda_ASYCUDA_ExtendedProperties.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> Deletexcuda_ASYCUDA_ExtendedProperties(string ASYCUDA_Id)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(ASYCUDA_Id);
                xcuda_ASYCUDA_ExtendedProperties entity = await dbContext.xcuda_ASYCUDA_ExtendedProperties
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (DocumentDSContext dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.xcuda_ASYCUDA_ExtendedProperties
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.xcuda_ASYCUDA_ExtendedProperties.Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await set//dbContext.xcuda_ASYCUDA_ExtendedProperties
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
								.OrderBy(y => y.ASYCUDA_Id)
			        ...
			        public async Task<IEnumerable<xcuda_ASYCUDA_ExtendedProperties>> Getxcuda_ASYCUDA_ExtendedPropertiesByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new DocumentDSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<xcuda_ASYCUDA_ExtendedProperties> entities = await set//dbContext.xcuda_ASYCUDA_ExtendedProperties
                                      .AsNoTracking()
