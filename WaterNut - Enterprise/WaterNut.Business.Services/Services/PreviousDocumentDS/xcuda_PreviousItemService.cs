...
namespace PreviousDocumentDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_PreviousItemService : Ixcuda_PreviousItemService, IDisposable
    {
        ...
        private static async Task<IEnumerable<xcuda_PreviousItem>> GetWhere<T>(PreviousDocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_PreviousItem>> GetWhereSelectMany<T>(PreviousDocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_PreviousItem>> GetWhereSelect<T>(PreviousDocumentDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<xcuda_PreviousItem> AddIncludes(IEnumerable<string> includesLst, PreviousDocumentDSContext dbContext)
       {
		 try
			{
