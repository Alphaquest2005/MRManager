    ...
    public partial class EntryDataDetailsService : IEntryDataDetailsService, IDisposable
    {
        ...
        public async Task<EntryDataDetails> CreateEntryDataDetails(EntryDataDetails entity)
        {
            try
            {
                using ( var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
              {
                dbContext.EntryDataDetails.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        private static async Task<IEnumerable<EntryDataDetails>> GetWhere<T>(PreviousDocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<EntryDataDetails>> GetWhereSelectMany<T>(PreviousDocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<EntryDataDetails>> GetWhereSelect<T>(PreviousDocumentDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<EntryDataDetails> AddIncludes(IEnumerable<string> includesLst, PreviousDocumentDSContext dbContext)
       {
		 try
			{
