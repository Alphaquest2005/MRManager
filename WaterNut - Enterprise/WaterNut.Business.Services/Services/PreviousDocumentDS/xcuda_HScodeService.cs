    ...
    public partial class xcuda_HScodeService : Ixcuda_HScodeService, IDisposable
    {
        ...
        public async Task<xcuda_HScode> Createxcuda_HScode(xcuda_HScode entity)
        {
            try
            {
                using ( var dbContext = new PreviousDocumentDSContext(){StartTracking = StartTracking})
              {
                dbContext.xcuda_HScode.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        private static async Task<IEnumerable<xcuda_HScode>> GetWhere<T>(PreviousDocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_HScode>> GetWhereSelectMany<T>(PreviousDocumentDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_HScode>> GetWhereSelect<T>(PreviousDocumentDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<xcuda_HScode> AddIncludes(IEnumerable<string> includesLst, PreviousDocumentDSContext dbContext)
       {
		 try
			{
