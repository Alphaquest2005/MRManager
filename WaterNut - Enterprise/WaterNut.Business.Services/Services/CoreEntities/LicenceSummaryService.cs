...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class LicenceSummaryService : ILicenceSummaryService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public LicenceSummaryService()
        {
            try
            {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<LicenceSummary> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<LicenceSummary> GetLicenceSummaryByKey(string RowNumber, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                LicenceSummary entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.RowNumber == i).ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocumentSetEx":
                                return
                                    await
                                        GetWhere<AsycudaDocumentSetEx>(dbContext, exp, itm.Value, "LicenceSummary", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<LicenceSummary>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<LicenceSummary> dset;
                                if (exp == "All")
                                {
                                    dset = set.OrderBy(x => x.RowNumber);
                                }
                                else
                                {
                                    dset = set.OrderBy(x => x.RowNumber).Where(exp);
                                }
        ...
        public async Task<LicenceSummary> CreateLicenceSummary(LicenceSummary entity)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.LicenceSummary.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> DeleteLicenceSummary(string RowNumber)
        {
            try
            {
              ...
              {
                var i = Convert.ToInt32(RowNumber);
                LicenceSummary entity = await dbContext.LicenceSummary
													.SingleOrDefaultAsync(x => x.RowNumber == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.LicenceSummary
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
            ...
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocumentSetEx":
                                return await CountWhere<AsycudaDocumentSetEx>(dbContext, exp, itm.Value, "LicenceSummary", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return await dbContext.LicenceSummary.Where(exp == "All" || exp == null ? "RowNumber != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<LicenceSummary>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocumentSetEx":
                                return
                                    await
                                        LoadRangeWhere<AsycudaDocumentSetEx>(startIndex, count, dbContext, exp, itm.Value, "LicenceSummary", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.LicenceSummary
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "RowNumber != null" : exp)
								.OrderBy(y => y.RowNumber)
		...
		private static async Task<IEnumerable<LicenceSummary>> LoadRangeWhere<T>(int startIndex, int count,
        ...
        private static async Task<IEnumerable<LicenceSummary>> GetWhere<T>(CoreEntitiesContext dbContext,
			        ...
			        public async Task<IEnumerable<LicenceSummary>> GetLicenceSummaryByAsycudaDocumentSetId(string AsycudaDocumentSetId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<LicenceSummary> entities = await set//dbContext.LicenceSummary
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.LicenceSummary.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.LicenceSummary.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.LicenceSummary
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocumentSetEx":
                                return await SumWhere<AsycudaDocumentSetEx>(dbContext, exp, itm.Value, "LicenceSummary", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.LicenceSummary.Where(exp == "All" || exp == null ? "RowNumber != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.LicenceSummary.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.LicenceSummary.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<LicenceSummary> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<LicenceSummary>) dbContext.LicenceSummary; 
	   ...
	   private IQueryable<LicenceSummary> AddWheres(List<string> expLst, IQueryable<LicenceSummary> set)
        {
            try
            {
