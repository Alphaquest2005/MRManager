...
namespace CoreEntities.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class SubItemsService : ISubItemsService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocumentItem":
                                return
                                    await
                                        GetWhere<AsycudaDocumentItem>(dbContext, exp, itm.Value, "SubItems", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocumentItem":
                                return await CountWhere<AsycudaDocumentItem>(dbContext, exp, itm.Value, "SubItems", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocumentItem":
                                return
                                    await
                                        LoadRangeWhere<AsycudaDocumentItem>(startIndex, count, dbContext, exp, itm.Value, "SubItems", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<SubItems>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<SubItems>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<SubItems>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
            ...
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocumentItem":
                                return await SumWhere<AsycudaDocumentItem>(dbContext, exp, itm.Value, "SubItems", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<SubItems> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
