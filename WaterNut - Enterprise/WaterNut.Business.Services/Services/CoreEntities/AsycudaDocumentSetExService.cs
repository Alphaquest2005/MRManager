...
{
   [Export (typeof(IAsycudaDocumentSetExService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class AsycudaDocumentSetExService : IAsycudaDocumentSetExService, IDisposable
    {
        //private readonly CoreEntitiesContext dbContext;

        public bool StartTracking { get; set; }

        public AsycudaDocumentSetExService()
        {
            try
            {
        ...
        public async Task<IEnumerable<AsycudaDocumentSetEx>> GetAsycudaDocumentSetExs(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AsycudaDocumentSetEx> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<AsycudaDocumentSetEx> GetAsycudaDocumentSetExByKey(string AsycudaDocumentSetId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                AsycudaDocumentSetEx entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.AsycudaDocumentSetId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<AsycudaDocumentSetEx>> GetAsycudaDocumentSetExsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<AsycudaDocumentSetEx>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<AsycudaDocumentSetEx>> GetAsycudaDocumentSetExsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<AsycudaDocumentSetEx>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<AsycudaDocumentSetEx>> GetAsycudaDocumentSetExsByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocuments":
                                return
                                    await
                                        GetWhere<AsycudaDocument>(dbContext, exp, itm.Value, "AsycudaDocumentSetEx", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);

                            case "LicenceSummary":
                                return
                                    await
                                        GetWhere<LicenceSummary>(dbContext, exp, itm.Value, "AsycudaDocumentSetEx", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<IEnumerable<AsycudaDocumentSetEx>> GetAsycudaDocumentSetExsByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<AsycudaDocumentSetEx>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<AsycudaDocumentSetEx> dset;
                                if (exp == "All")
                                {
        ...
        public async Task<IEnumerable<AsycudaDocumentSetEx>> GetAsycudaDocumentSetExsByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<AsycudaDocumentSetEx> CreateAsycudaDocumentSetEx(AsycudaDocumentSetEx entity)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.AsycudaDocumentSetExs.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> DeleteAsycudaDocumentSetEx(string AsycudaDocumentSetId)
        {
            try
            {
              using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(AsycudaDocumentSetId);
                AsycudaDocumentSetEx entity = await dbContext.AsycudaDocumentSetExs
													.SingleOrDefaultAsync(x => x.AsycudaDocumentSetId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.AsycudaDocumentSetExs.Attach(entity);
                    dbContext.AsycudaDocumentSetExs.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<AsycudaDocumentSetEx>)dbContext.AsycudaDocumentSetExs; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CoreEntitiesContext dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.AsycudaDocumentSetExs
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<AsycudaDocumentSetEx>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
            ...
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocuments":
                                return await CountWhere<AsycudaDocument>(dbContext, exp, itm.Value, "AsycudaDocumentSetEx", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "LicenceSummary":
                                return await CountWhere<LicenceSummary>(dbContext, exp, itm.Value, "AsycudaDocumentSetEx", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return await dbContext.AsycudaDocumentSetExs.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<AsycudaDocumentSetEx>()
		...
		private static async Task<int> CountWhereSelect<T>(CoreEntitiesContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<AsycudaDocumentSetEx>()
                .Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
                .Distinct()
                .OrderBy("AsycudaDocumentSetId")
                .CountAsync()
		  ...
		  public async Task<IEnumerable<AsycudaDocumentSetEx>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<AsycudaDocumentSetEx>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "AsycudaDocuments":
                                return
                                    await
                                        LoadRangeWhere<AsycudaDocument>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentSetEx", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);

                            case "LicenceSummary":
                                return
                                    await
                                        LoadRangeWhere<LicenceSummary>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentSetEx", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.AsycudaDocumentSetExs
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
								.OrderBy(y => y.AsycudaDocumentSetId)
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEx>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEx>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEx>> LoadRangeSelect<T>(int startIndex, int count,
            CoreEntitiesContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<AsycudaDocumentSetEx>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEx>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<AsycudaDocumentSetEx>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<AsycudaDocumentSetEx>()
                .Where(exp == "All" || exp == null?"AsycudaDocumentSetId != null":exp)
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEx>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<AsycudaDocumentSetEx>> GetAsycudaDocumentSetExByCustoms_ProcedureId(string Customs_ProcedureId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<AsycudaDocumentSetEx> entities = await set//dbContext.AsycudaDocumentSetExs
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.AsycudaDocumentSetExs.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.AsycudaDocumentSetExs.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                {
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.AsycudaDocumentSetExs
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "AsycudaDocuments":
                                return await SumWhere<AsycudaDocument>(dbContext, exp, itm.Value, "AsycudaDocumentSetEx", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "LicenceSummary":
                                return await SumWhere<LicenceSummary>(dbContext, exp, itm.Value, "AsycudaDocumentSetEx", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.AsycudaDocumentSetExs.Where(exp == "All" || exp == null ? "AsycudaDocumentSetId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.AsycudaDocumentSetExs.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.AsycudaDocumentSetExs.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<AsycudaDocumentSetEx> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<AsycudaDocumentSetEx>) dbContext.AsycudaDocumentSetExs; 
	   ...
	   private IQueryable<AsycudaDocumentSetEx> AddWheres(List<string> expLst, IQueryable<AsycudaDocumentSetEx> set)
        {
            try
            {
