    ...
    public partial class Customs_ProcedureService : ICustoms_ProcedureService, IDisposable
    {
        ...
        public async Task<Customs_Procedure> CreateCustoms_Procedure(Customs_Procedure entity)
        {
            try
            {
                using ( var dbContext = new CoreEntitiesContext(){StartTracking = StartTracking})
              {
                dbContext.Customs_Procedure.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        private static async Task<IEnumerable<Customs_Procedure>> GetWhere<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<Customs_Procedure>> GetWhereSelectMany<T>(CoreEntitiesContext dbContext,
		...
		private static async Task<IEnumerable<Customs_Procedure>> GetWhereSelect<T>(CoreEntitiesContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<Customs_Procedure> AddIncludes(IEnumerable<string> includesLst, CoreEntitiesContext dbContext)
       {
		 try
			{
