    ...
    public partial class TariffCategoryService : ITariffCategoryService, IDisposable
    {
            ...
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "TariffSupUnitLkps":
                                return
                                    await
                                        GetWhere<TariffSupUnitLkps>(dbContext, exp, itm.Value, "TariffCategory", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<TariffCategory> CreateTariffCategory(TariffCategory entity)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                dbContext.TariffCategory.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
            ...
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "TariffSupUnitLkps":
                                return await CountWhere<TariffSupUnitLkps>(dbContext, exp, itm.Value, "TariffCategory", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "TariffCodes":
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "TariffSupUnitLkps":
                                return
                                    await
                                        LoadRangeWhere<TariffSupUnitLkps>(startIndex, count, dbContext, exp, itm.Value, "TariffCategory", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
            ...
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "TariffSupUnitLkps":
                                return await SumWhere<TariffSupUnitLkps>(dbContext, exp, itm.Value, "TariffCategory", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "TariffCodes":
