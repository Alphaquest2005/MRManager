...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class xcuda_WeightService : Ixcuda_WeightService, IDisposable
    {
        ...
        private static async Task<IEnumerable<xcuda_Weight>> GetWhere<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Weight>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Weight>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<xcuda_Weight> AddIncludes(IEnumerable<string> includesLst, AllocationDSContext dbContext)
       {
		 try
			{
