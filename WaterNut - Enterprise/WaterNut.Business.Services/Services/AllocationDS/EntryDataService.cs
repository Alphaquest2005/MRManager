    ...
    public partial class EntryDataService : IEntryDataService, IDisposable
    {
        ...
        public async Task<EntryData> CreateEntryData(EntryData entity)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                dbContext.EntryData.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        private static async Task<IEnumerable<EntryData>> GetWhere<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<EntryData>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<EntryData>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<EntryData> AddIncludes(IEnumerable<string> includesLst, AllocationDSContext dbContext)
       {
		 try
			{
