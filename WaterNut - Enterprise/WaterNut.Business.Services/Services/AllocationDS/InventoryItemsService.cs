...
namespace AllocationDS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemsService : IInventoryItemsService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "TariffCodes":
                                return
                                    await
                                        GetWhere<TariffCodes>(dbContext, exp, itm.Value, "InventoryItems", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
                            ...
                            case "EX9AsycudaSalesAllocations":
                                return
                                    await
                                        GetWhere<EX9AsycudaSalesAllocations>(dbContext, exp, itm.Value, "InventoryItem", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
                        ...
                        switch (itm.Key)
                        {
                            case "EntryDataDetails":
                                return await CountWhere<EntryDataDetails>(dbContext, exp, itm.Value, "InventoryItem", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "TariffCodes":
                                return await CountWhere<TariffCodes>(dbContext, exp, itm.Value, "InventoryItems", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryItemAlias":
                                return await CountWhere<InventoryItemAlias>(dbContext, exp, itm.Value, "InventoryItems", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "EX9AsycudaSalesAllocations":
                                return await CountWhere<EX9AsycudaSalesAllocations>(dbContext, exp, itm.Value, "InventoryItem", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "TariffCodes":
                                return
                                    await
                                        LoadRangeWhere<TariffCodes>(startIndex, count, dbContext, exp, itm.Value, "InventoryItems", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                            ...
                            case "EX9AsycudaSalesAllocations":
                                return
                                    await
                                        LoadRangeWhere<EX9AsycudaSalesAllocations>(startIndex, count, dbContext, exp, itm.Value, "InventoryItem", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<InventoryItems>> GetWhere<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItems>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItems>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
                        ...
                        switch (itm.Key)
                        {
                            case "EntryDataDetails":
                                return await SumWhere<EntryDataDetails>(dbContext, exp, itm.Value, "InventoryItem", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "TariffCodes":
                                return await SumWhere<TariffCodes>(dbContext, exp, itm.Value, "InventoryItems", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryItemAlias":
                                return await SumWhere<InventoryItemAlias>(dbContext, exp, itm.Value, "InventoryItems", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "EX9AsycudaSalesAllocations":
                                return await SumWhere<EX9AsycudaSalesAllocations>(dbContext, exp, itm.Value, "InventoryItem", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<InventoryItems> AddIncludes(IEnumerable<string> includesLst, AllocationDSContext dbContext)
       {
		 try
			{
