    ...
    public partial class xcuda_TarificationService : Ixcuda_TarificationService, IDisposable
    {
        ...
        public async Task<xcuda_Tarification> Createxcuda_Tarification(xcuda_Tarification entity)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                dbContext.xcuda_Tarification.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        private static async Task<IEnumerable<xcuda_Tarification>> GetWhere<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Tarification>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Tarification>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<xcuda_Tarification> AddIncludes(IEnumerable<string> includesLst, AllocationDSContext dbContext)
       {
		 try
			{
