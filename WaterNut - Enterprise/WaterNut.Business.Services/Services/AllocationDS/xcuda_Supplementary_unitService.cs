    ...
    public partial class xcuda_Supplementary_unitService : Ixcuda_Supplementary_unitService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xcuda_Tarification":
                                return
                                    await
                                        GetWhere<xcuda_Tarification>(dbContext, exp, itm.Value, "xcuda_Supplementary_unit", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<xcuda_Supplementary_unit> Createxcuda_Supplementary_unit(xcuda_Supplementary_unit entity)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                dbContext.xcuda_Supplementary_unit.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
            ...
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xcuda_Tarification":
                                return await CountWhere<xcuda_Tarification>(dbContext, exp, itm.Value, "xcuda_Supplementary_unit", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "xcuda_Tarification":
                                return
                                    await
                                        LoadRangeWhere<xcuda_Tarification>(startIndex, count, dbContext, exp, itm.Value, "xcuda_Supplementary_unit", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<xcuda_Supplementary_unit>> GetWhere<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Supplementary_unit>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<xcuda_Supplementary_unit>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
            ...
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "xcuda_Tarification":
                                return await SumWhere<xcuda_Tarification>(dbContext, exp, itm.Value, "xcuda_Supplementary_unit", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<xcuda_Supplementary_unit> AddIncludes(IEnumerable<string> includesLst, AllocationDSContext dbContext)
       {
		 try
			{
