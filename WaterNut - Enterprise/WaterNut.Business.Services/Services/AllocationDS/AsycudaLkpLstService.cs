...
{
   [Export (typeof(IAsycudaLkpLstService))]
   [Export(typeof(IBusinessService))]
   [PartCreationPolicy(CreationPolicy.NonShared)]
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
                    ConcurrencyMode = ConcurrencyMode.Multiple)]
   
    public partial class AsycudaLkpLstService : IAsycudaLkpLstService, IDisposable
    {
        //private readonly AllocationDSContext dbContext;

        public bool StartTracking { get; set; }

        public AsycudaLkpLstService()
        {
            try
            {
        ...
        public async Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLst(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<AsycudaLkpLst> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<AsycudaLkpLst> GetAsycudaLkpLstByKey(string ASYCUDA_Id, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                AsycudaLkpLst entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.ASYCUDA_Id == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<AsycudaLkpLst>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<AsycudaLkpLst>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<AsycudaLkpLst>>();
        ...
        public async Task<IEnumerable<AsycudaLkpLst>> GetAsycudaLkpLstByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<AsycudaLkpLst> UpdateAsycudaLkpLst(AsycudaLkpLst entity)
        { 
            using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                try
        ...
        public async Task<AsycudaLkpLst> CreateAsycudaLkpLst(AsycudaLkpLst entity)
        {
            try
            {
                using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                dbContext.AsycudaLkpLst.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> DeleteAsycudaLkpLst(string ASYCUDA_Id)
        {
            try
            {
              using ( var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(ASYCUDA_Id);
                AsycudaLkpLst entity = await dbContext.AsycudaLkpLst
													.SingleOrDefaultAsync(x => x.ASYCUDA_Id == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.AsycudaLkpLst.Attach(entity);
                    dbContext.AsycudaLkpLst.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<AsycudaLkpLst>)dbContext.AsycudaLkpLst; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (AllocationDSContext dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.AsycudaLkpLst
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<AsycudaLkpLst>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.AsycudaLkpLst.Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(AllocationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<AsycudaLkpLst>()
		...
		private static async Task<int> CountWhereSelect<T>(AllocationDSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<AsycudaLkpLst>()
                .Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
                .Distinct()
                .OrderBy("ASYCUDA_Id")
                .CountAsync()
		  ...
		  public async Task<IEnumerable<AsycudaLkpLst>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<AsycudaLkpLst>();
                    ...
                    return await set//dbContext.AsycudaLkpLst
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
								.OrderBy(y => y.ASYCUDA_Id)
		...
		private static async Task<IEnumerable<AsycudaLkpLst>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<AsycudaLkpLst>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<AsycudaLkpLst>> LoadRangeSelect<T>(int startIndex, int count,
            AllocationDSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<AsycudaLkpLst>> GetWhere<T>(AllocationDSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaLkpLst>> GetWhereSelectMany<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<AsycudaLkpLst>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<AsycudaLkpLst>()
                .Where(exp == "All" || exp == null?"ASYCUDA_Id != null":exp)
		...
		private static async Task<IEnumerable<AsycudaLkpLst>> GetWhereSelect<T>(AllocationDSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.AsycudaLkpLst.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.AsycudaLkpLst.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                {
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.AsycudaLkpLst
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.AsycudaLkpLst.Where(exp == "All" || exp == null ? "ASYCUDA_Id != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new AllocationDSContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.AsycudaLkpLst.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.AsycudaLkpLst.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<AsycudaLkpLst> AddIncludes(IEnumerable<string> includesLst, AllocationDSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<AsycudaLkpLst>) dbContext.AsycudaLkpLst; 
	   ...
	   private IQueryable<AsycudaLkpLst> AddWheres(List<string> expLst, IQueryable<AsycudaLkpLst> set)
        {
            try
            {
