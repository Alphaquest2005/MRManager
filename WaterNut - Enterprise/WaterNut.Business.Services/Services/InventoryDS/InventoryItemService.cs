                ...
                using (var dbContext = new InventoryDSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "InventoryAsycudaMappings":
                                return
                                    await
                                        GetWhere<InventoryAsycudaMapping>(dbContext, exp, itm.Value, "InventoryItem", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "InventoryItemAlias":
                                return await CountWhere<InventoryItemAlia>(dbContext, exp, itm.Value, "InventoryItem", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryAsycudaMappings":
                                return await CountWhere<InventoryAsycudaMapping>(dbContext, exp, itm.Value, "InventoryItem", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "InventoryAsycudaMappings":
                                return
                                    await
                                        LoadRangeWhere<InventoryAsycudaMapping>(startIndex, count, dbContext, exp, itm.Value, "InventoryItem", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
                        ...
                        switch (itm.Key)
                        {
                            ...
                            case "InventoryItemAlias":
                                return await SumWhere<InventoryItemAlia>(dbContext, exp, itm.Value, "InventoryItem", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "InventoryAsycudaMappings":
                                return await SumWhere<InventoryAsycudaMapping>(dbContext, exp, itm.Value, "InventoryItem", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
