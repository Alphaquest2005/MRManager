...
namespace EntryDataQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class AsycudaDocumentSetEntryDataService : IAsycudaDocumentSetEntryDataService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "EntryDataEx":
                                return
                                    await
                                        GetWhere<EntryDataEx>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "EntryDataEx":
                                return await CountWhere<EntryDataEx>(dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "EntryDataEx":
                                return
                                    await
                                        LoadRangeWhere<EntryDataEx>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentSets", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhere<T>(EntryDataQSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelectMany<T>(EntryDataQSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentSetEntryData>> GetWhereSelect<T>(EntryDataQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
            ...
            try
            {
                ...
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "EntryDataEx":
                                return await SumWhere<EntryDataEx>(dbContext, exp, itm.Value, "AsycudaDocumentSets", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<AsycudaDocumentSetEntryData> AddIncludes(IEnumerable<string> includesLst, EntryDataQSContext dbContext)
       {
		 try
			{
