    ...
    public partial class PackageTypeService : IPackageTypeService, IDisposable
    {
            ...
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<PackageType> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<PackageType> GetPackageTypeByKey(string PackageCode, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
              {
                var i = PackageCode;
				var set = AddIncludes(includesLst, dbContext);
                PackageType entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.PackageCode == i).ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<bool> DeletePackageType(string PackageCode)
        {
            try
            {
              ...
              {
                var i = PackageCode;
                PackageType entity = await dbContext.PackageTypes
													.SingleOrDefaultAsync(x => x.PackageCode == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new EntryDataQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.PackageTypes.Where(exp == "All" || exp == null ? "PackageCode != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
        ...
        private static async Task<IEnumerable<PackageType>> GetWhere<T>(EntryDataQSContext dbContext,
		...
		private static async Task<IEnumerable<PackageType>> GetWhereSelectMany<T>(EntryDataQSContext dbContext,
		...
		private static async Task<IEnumerable<PackageType>> GetWhereSelect<T>(EntryDataQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<PackageType> AddIncludes(IEnumerable<string> includesLst, EntryDataQSContext dbContext)
       {
		 try
			{
