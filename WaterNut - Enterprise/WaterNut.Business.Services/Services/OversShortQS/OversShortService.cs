...
namespace OversShortQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class OversShortService : IOversShortService, IDisposable
    {
        ...
        public async Task<IEnumerable<OversShort>> GetOversShorts(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<OversShort> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<OversShort> GetOversShortByKey(string OversShortsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                OversShort entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.OversShortsId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<OversShort>> GetOversShortsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<OversShort>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<OversShort>> GetOversShortsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<OversShort>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<OversShort>> GetOversShortsByExpressionNav(string exp,
        ...
        public async Task<IEnumerable<OversShort>> GetOversShortsByBatch(string exp,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {

                var res = new ConcurrentQueue<List<OversShort>>();
        ...
        public async Task<IEnumerable<OversShort>> GetOversShortsByBatchExpressionLst(List<string> expLst,
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
        ...
        public async Task<OversShort> CreateOversShort(OversShort entity)
        {
            try
            {
                using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
                dbContext.OversShorts.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> DeleteOversShort(string OversShortsId)
        {
            try
            {
              using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(OversShortsId);
                OversShort entity = await dbContext.OversShorts
													.SingleOrDefaultAsync(x => x.OversShortsId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.OversShorts.Attach(entity);
                    dbContext.OversShorts.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<OversShort>)dbContext.OversShorts; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (OversShortQSContext dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.OversShorts
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<OversShort>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.OversShorts.Where(exp == "All" || exp == null ? "OversShortsId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(OversShortQSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OversShort>()
		...
		private static async Task<int> CountWhereSelect<T>(OversShortQSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<OversShort>()
                .Where(exp == "All" || exp == null ? "OversShortsId != null" : exp)
                .Distinct()
                .OrderBy("OversShortsId")
                .CountAsync()
		  ...
		  public async Task<IEnumerable<OversShort>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<OversShort>();
                    ...
                    return await set//dbContext.OversShorts
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "OversShortsId != null" : exp)
								.OrderBy(y => y.OversShortsId)
		...
		private static async Task<IEnumerable<OversShort>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OversShort>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OversShort>> LoadRangeSelect<T>(int startIndex, int count,
            OversShortQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<OversShort>> GetWhere<T>(OversShortQSContext dbContext,
		...
		private static async Task<IEnumerable<OversShort>> GetWhereSelectMany<T>(OversShortQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<OversShort>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OversShort>()
                .Where(exp == "All" || exp == null?"OversShortsId != null":exp)
		...
		private static async Task<IEnumerable<OversShort>> GetWhereSelect<T>(OversShortQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.OversShorts.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.OversShorts.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.OversShorts
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.OversShorts.Where(exp == "All" || exp == null ? "OversShortsId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.OversShorts.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.OversShorts.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<OversShort> AddIncludes(IEnumerable<string> includesLst, OversShortQSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<OversShort>) dbContext.OversShorts; 
	   ...
	   private IQueryable<OversShort> AddWheres(List<string> expLst, IQueryable<OversShort> set)
        {
            try
            {
