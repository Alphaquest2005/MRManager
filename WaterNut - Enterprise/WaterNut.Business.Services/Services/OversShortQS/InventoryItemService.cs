...
namespace OversShortQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class InventoryItemService : IInventoryItemService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "OverShortDetailsEXes":
                                return
                                    await
                                        GetWhere<OverShortDetailsEX>(dbContext, exp, itm.Value, "InventoryItem", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            try
            {
                ...
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "OverShortDetailsEXes":
                                return await CountWhere<OverShortDetailsEX>(dbContext, exp, itm.Value, "InventoryItem", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "OverShortDetailsEXes":
                                return
                                    await
                                        LoadRangeWhere<OverShortDetailsEX>(startIndex, count, dbContext, exp, itm.Value, "InventoryItem", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<InventoryItem>> GetWhere<T>(OversShortQSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItem>> GetWhereSelectMany<T>(OversShortQSContext dbContext,
		...
		private static async Task<IEnumerable<InventoryItem>> GetWhereSelect<T>(OversShortQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
            ...
            try
            {
                ...
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "OverShortDetailsEXes":
                                return await SumWhere<OverShortDetailsEX>(dbContext, exp, itm.Value, "InventoryItem", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<InventoryItem> AddIncludes(IEnumerable<string> includesLst, OversShortQSContext dbContext)
       {
		 try
			{
