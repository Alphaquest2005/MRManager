...
namespace OversShortQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class OverShortDetailService : IOverShortDetailService, IDisposable
    {
        //private readonly OversShortQSContext dbContext;

        public bool StartTracking { get; set; }

        public OverShortDetailService()
        {
            try
            {
        ...
        public async Task<IEnumerable<OverShortDetail>> GetOverShortDetails(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<OverShortDetail> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<OverShortDetail> GetOverShortDetailByKey(string OverShortDetailId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                OverShortDetail entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.OverShortDetailId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<OverShortDetail>> GetOverShortDetailsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<OverShortDetail>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<OverShortDetail>> GetOverShortDetailsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<OverShortDetail>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<OverShortDetail>> GetOverShortDetailsByExpressionNav(string exp,
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<OverShortDetail>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<OverShortDetail> dset;
                                if (exp == "All")
                                {
        ...
        public async Task<OverShortDetail> CreateOverShortDetail(OverShortDetail entity)
        {
            try
            {
                using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
                dbContext.OverShortDetails.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> DeleteOverShortDetail(string OverShortDetailId)
        {
            try
            {
              using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(OverShortDetailId);
                OverShortDetail entity = await dbContext.OverShortDetails
													.SingleOrDefaultAsync(x => x.OverShortDetailId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.OverShortDetails.Attach(entity);
                    dbContext.OverShortDetails.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<OverShortDetail>)dbContext.OverShortDetails; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (OversShortQSContext dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.OverShortDetails
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<OverShortDetail>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.OverShortDetails.Where(exp == "All" || exp == null ? "OverShortDetailId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(OversShortQSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OverShortDetail>()
		...
		private static async Task<int> CountWhereSelect<T>(OversShortQSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<OverShortDetail>()
                .Where(exp == "All" || exp == null ? "OverShortDetailId != null" : exp)
                .Distinct()
                .OrderBy("OverShortDetailId")
                .CountAsync()
		  ...
		  public async Task<IEnumerable<OverShortDetail>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<OverShortDetail>();
                    ...
                    return await set//dbContext.OverShortDetails
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "OverShortDetailId != null" : exp)
								.OrderBy(y => y.OverShortDetailId)
		...
		private static async Task<IEnumerable<OverShortDetail>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OverShortDetail>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OverShortDetail>> LoadRangeSelect<T>(int startIndex, int count,
            OversShortQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<OverShortDetail>> GetWhere<T>(OversShortQSContext dbContext,
		...
		private static async Task<IEnumerable<OverShortDetail>> GetWhereSelectMany<T>(OversShortQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<OverShortDetail>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OverShortDetail>()
                .Where(exp == "All" || exp == null?"OverShortDetailId != null":exp)
		...
		private static async Task<IEnumerable<OverShortDetail>> GetWhereSelect<T>(OversShortQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
			        ...
			        public async Task<IEnumerable<OverShortDetail>> GetOverShortDetailByOversShortsId(string OversShortsId, List<string> includesLst = null)
        {
            try
            {
                using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
                ...
                var set = AddIncludes(includesLst, dbContext);
                IEnumerable<OverShortDetail> entities = await set//dbContext.OverShortDetails
                                                    // .Include(x => x.OverShortDetailAllocations)									  
                                      .AsNoTracking()
             ...
             try
             {
                 using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.OverShortDetails.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.OverShortDetails.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.OverShortDetails
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    ...
                    return Convert.ToDecimal(dbContext.OverShortDetails.Where(exp == "All" || exp == null ? "OverShortDetailId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.OverShortDetails.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.OverShortDetails.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<OverShortDetail> AddIncludes(IEnumerable<string> includesLst, OversShortQSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<OverShortDetail>) dbContext.OverShortDetails; 
	   ...
	   private IQueryable<OverShortDetail> AddWheres(List<string> expLst, IQueryable<OverShortDetail> set)
        {
            try
            {
