    ...
    public partial class AsycudaDocumentItemService : IAsycudaDocumentItemService, IDisposable
    {
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "OverShortAllocationsEXes":
                                return
                                    await
                                        GetWhere<OverShortAllocationsEX>(dbContext, exp, itm.Value, "AsycudaDocumentItem", "Select", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
        ...
        public async Task<AsycudaDocumentItem> CreateAsycudaDocumentItem(AsycudaDocumentItem entity)
        {
            try
            {
                using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
                dbContext.AsycudaDocumentItems.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
                        ...
                        switch (itm.Key)
                        {
                            case "AsycudaDocument":
                                return await CountWhere<AsycudaDocument>(dbContext, exp, itm.Value, "AsycudaDocumentItems", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "OverShortAllocationsEXes":
                                return await CountWhere<OverShortAllocationsEX>(dbContext, exp, itm.Value, "AsycudaDocumentItem", "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            ...
                            case "OverShortAllocationsEXes":
                                return
                                    await
                                        LoadRangeWhere<OverShortAllocationsEX>(startIndex, count, dbContext, exp, itm.Value, "AsycudaDocumentItem", "Select")
													.ConfigureAwait(continueOnCapturedContext: false);
        ...
        private static async Task<IEnumerable<AsycudaDocumentItem>> GetWhere<T>(OversShortQSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentItem>> GetWhereSelectMany<T>(OversShortQSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocumentItem>> GetWhereSelect<T>(OversShortQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
                        ...
                        switch (itm.Key)
                        {
                            case "AsycudaDocument":
                                return await SumWhere<AsycudaDocument>(dbContext, exp, itm.Value, "AsycudaDocumentItems", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
                            case "OverShortAllocationsEXes":
                                return await SumWhere<OverShortAllocationsEX>(dbContext, exp, itm.Value, "AsycudaDocumentItem", field, "Select")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
		...
		private static IQueryable<AsycudaDocumentItem> AddIncludes(IEnumerable<string> includesLst, OversShortQSContext dbContext)
       {
		 try
			{
