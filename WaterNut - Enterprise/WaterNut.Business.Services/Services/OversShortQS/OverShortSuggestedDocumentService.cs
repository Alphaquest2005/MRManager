...
namespace OversShortQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class OverShortSuggestedDocumentService : IOverShortSuggestedDocumentService, IDisposable
    {
        //private readonly OversShortQSContext dbContext;

        public bool StartTracking { get; set; }

        public OverShortSuggestedDocumentService()
        {
            try
            {
        ...
        public async Task<IEnumerable<OverShortSuggestedDocument>> GetOverShortSuggestedDocuments(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<OverShortSuggestedDocument> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<OverShortSuggestedDocument> GetOverShortSuggestedDocumentByKey(string OversShortsId, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
				...
				var set = AddIncludes(includesLst, dbContext);
                OverShortSuggestedDocument entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.OversShortsId == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<OverShortSuggestedDocument>> GetOverShortSuggestedDocumentsByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<OverShortSuggestedDocument>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<OverShortSuggestedDocument>> GetOverShortSuggestedDocumentsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<OverShortSuggestedDocument>();
					var set = AddIncludes(includesLst, dbContext);
		...
		public async Task<IEnumerable<OverShortSuggestedDocument>> GetOverShortSuggestedDocumentsByExpressionNav(string exp,
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "OversShortEX":
                                return
                                    await
                                        GetWhere<OversShortEX>(dbContext, exp, itm.Value, "OverShortSuggestedDocuments", "SelectMany", includesLst)
										.ConfigureAwait(continueOnCapturedContext: false);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<OverShortSuggestedDocument>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<OverShortSuggestedDocument> dset;
                                if (exp == "All")
                                {
        ...
        public async Task<OverShortSuggestedDocument> CreateOverShortSuggestedDocument(OverShortSuggestedDocument entity)
        {
            try
            {
                using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
                dbContext.OverShortSuggestedDocuments.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> DeleteOverShortSuggestedDocument(string OversShortsId)
        {
            try
            {
              using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
                var i = Convert.ToInt32(OversShortsId);
                OverShortSuggestedDocument entity = await dbContext.OverShortSuggestedDocuments
													.SingleOrDefaultAsync(x => x.OversShortsId == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.OverShortSuggestedDocuments.Attach(entity);
                    dbContext.OverShortSuggestedDocuments.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<OverShortSuggestedDocument>)dbContext.OverShortSuggestedDocuments; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (OversShortQSContext dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.OverShortSuggestedDocuments
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
        ...
        public async Task<IEnumerable<OverShortSuggestedDocument>> LoadRange(int startIndex, int count, string exp)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
            ...
            try
            {
                ...
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    ...
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "OversShortEX":
                                return await CountWhere<OversShortEX>(dbContext, exp, itm.Value, "OverShortSuggestedDocuments", "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return await dbContext.OverShortSuggestedDocuments.Where(exp == "All" || exp == null ? "OversShortsId != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(OversShortQSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OverShortSuggestedDocument>()
		...
		private static async Task<int> CountWhereSelect<T>(OversShortQSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<OverShortSuggestedDocument>()
                .Where(exp == "All" || exp == null ? "OversShortsId != null" : exp)
                .Distinct()
                .OrderBy("OversShortsId")
                .CountAsync()
		  ...
		  public async Task<IEnumerable<OverShortSuggestedDocument>> LoadRangeNav(int startIndex, int count, string exp,
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<OverShortSuggestedDocument>();
                    ...
                    foreach (var itm in navExp)
                    {
                        switch (itm.Key)
                        {
                            case "OversShortEX":
                                return
                                    await
                                        LoadRangeWhere<OversShortEX>(startIndex, count, dbContext, exp, itm.Value, "OverShortSuggestedDocuments", "SelectMany")
													.ConfigureAwait(continueOnCapturedContext: false);
                    ...
                    return await set//dbContext.OverShortSuggestedDocuments
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "OversShortsId != null" : exp)
								.OrderBy(y => y.OversShortsId)
		...
		private static async Task<IEnumerable<OverShortSuggestedDocument>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OverShortSuggestedDocument>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<OverShortSuggestedDocument>> LoadRangeSelect<T>(int startIndex, int count,
            OversShortQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<OverShortSuggestedDocument>> GetWhere<T>(OversShortQSContext dbContext,
		...
		private static async Task<IEnumerable<OverShortSuggestedDocument>> GetWhereSelectMany<T>(OversShortQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<OverShortSuggestedDocument>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<OverShortSuggestedDocument>()
                .Where(exp == "All" || exp == null?"OversShortsId != null":exp)
		...
		private static async Task<IEnumerable<OverShortSuggestedDocument>> GetWhereSelect<T>(OversShortQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.OverShortSuggestedDocuments.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.OverShortSuggestedDocuments.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                {
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.OverShortSuggestedDocuments
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    foreach (var itm in navExp)
                    {
                        ...
                        {
                            case "OversShortEX":
                                return await SumWhere<OversShortEX>(dbContext, exp, itm.Value, "OverShortSuggestedDocuments", field, "SelectMany")
											.ConfigureAwait(continueOnCapturedContext: false);
						}
                    }
                    return Convert.ToDecimal(dbContext.OverShortSuggestedDocuments.Where(exp == "All" || exp == null ? "OversShortsId != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.OverShortSuggestedDocuments.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.OverShortSuggestedDocuments.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<OverShortSuggestedDocument> AddIncludes(IEnumerable<string> includesLst, OversShortQSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<OverShortSuggestedDocument>) dbContext.OverShortSuggestedDocuments; 
	   ...
	   private IQueryable<OverShortSuggestedDocument> AddWheres(List<string> expLst, IQueryable<OverShortSuggestedDocument> set)
        {
            try
            {
