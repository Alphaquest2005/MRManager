    ...
    public partial class AsycudaDocumentService : IAsycudaDocumentService, IDisposable
    {
        ...
        public async Task<AsycudaDocument> CreateAsycudaDocument(AsycudaDocument entity)
        {
            try
            {
                using ( var dbContext = new OversShortQSContext(){StartTracking = StartTracking})
              {
                dbContext.AsycudaDocuments.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        private static async Task<IEnumerable<AsycudaDocument>> GetWhere<T>(OversShortQSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocument>> GetWhereSelectMany<T>(OversShortQSContext dbContext,
		...
		private static async Task<IEnumerable<AsycudaDocument>> GetWhereSelect<T>(OversShortQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
		...
		private static IQueryable<AsycudaDocument> AddIncludes(IEnumerable<string> includesLst, OversShortQSContext dbContext)
       {
		 try
			{
