...
namespace CounterPointQS.Business.Services
{
   ...
   [ServiceBehavior(InstanceContextMode = InstanceContextMode.PerCall,
    ...
    public partial class CounterPointSalesService : ICounterPointSalesService, IDisposable
    {
        //private readonly CounterPointQSContext dbContext;

        public bool StartTracking { get; set; }

        public CounterPointSalesService()
        {
            try
            {
        ...
        public async Task<IEnumerable<CounterPointSales>> GetCounterPointSales(List<string> includesLst = null, bool tracking = true)
        {
            try
            {
            //using (var scope = new TransactionScope(TransactionScopeOption.Required,
               ...
               // {
                  using ( var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                  {
                    ...
                    IEnumerable<CounterPointSales> entities = await set.AsNoTracking().ToListAsync()
        ...
        public async Task<CounterPointSales> GetCounterPointSalesByKey(string InvoiceNo, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
              ...
              using ( var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
              {
                var i = InvoiceNo;
				var set = AddIncludes(includesLst, dbContext);
                CounterPointSales entity = await set.AsNoTracking().SingleOrDefaultAsync(x => x.InvoiceNo == i).ConfigureAwait(continueOnCapturedContext: false);
		 ...
		 public async Task<IEnumerable<CounterPointSales>> GetCounterPointSalesByExpression(string exp, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
					if (string.IsNullOrEmpty(exp) || exp == "None") return new List<CounterPointSales>();
					var set = AddIncludes(includesLst, dbContext);
                    if (exp == "All")
                    {
		 ...
		 public async Task<IEnumerable<CounterPointSales>> GetCounterPointSalesByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
					if (expLst.Count == 0 || expLst.FirstOrDefault() == "None") return new List<CounterPointSales>();
					var set = AddIncludes(includesLst, dbContext);
            ...
            int totalrow, List<string> includesLst = null, bool tracking = true)
        {
            try
            {
                ...
                var res = new ConcurrentQueue<List<CounterPointSales>>();
                    ...
                    //  for (int bat = 0; bat < batches; bat++)
                    {
                        try
                        {
                            using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                            {
                                ...
                                var set = AddIncludes(includesLst, dbContext);
                                IQueryable<CounterPointSales> dset;
                                if (exp == "All")
                                {
        ...
        public async Task<CounterPointSales> CreateCounterPointSales(CounterPointSales entity)
        {
            try
            {
                using ( var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
              {
                dbContext.CounterPointSales.Add(entity);
                await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                entity.AcceptChanges();
                return entity;
              }
        ...
        public async Task<bool> DeleteCounterPointSales(string InvoiceNo)
        {
            try
            {
              using ( var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
              {
                var i = InvoiceNo;
                CounterPointSales entity = await dbContext.CounterPointSales
													.SingleOrDefaultAsync(x => x.InvoiceNo == i)
													.ConfigureAwait(continueOnCapturedContext: false);
                if (entity == null)
                    return false;

                    dbContext.CounterPointSales.Attach(entity);
                    dbContext.CounterPointSales.Remove(entity);
                    await dbContext.SaveChangesAsync().ConfigureAwait(continueOnCapturedContext: false);
                    return true;
              }
            }
         ...
         public async Task<int> CountByExpressionLst(List<string> expLst)
        {
            try
            {
                using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
                    ...
                    var set = (IQueryable<CounterPointSales>)dbContext.CounterPointSales; 
                    if (expLst.FirstOrDefault() == "All")
                    {
		...
		public async Task<int> Count(string exp)
        {
            try
            {
                using (CounterPointQSContext dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
                    ...
                    if (exp == "All")
                    {
                        return await dbContext.CounterPointSales
                                    .AsNoTracking()
									.CountAsync()
									.ConfigureAwait(continueOnCapturedContext: false);
                    }
		...
		public async Task<int> CountNav(string exp, Dictionary<string, string> navExp)
        {
            try
            {
                ...
                using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
                    ...
                    return await dbContext.CounterPointSales.Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
											.AsNoTracking()
                                            .CountAsync()
											.ConfigureAwait(continueOnCapturedContext: false);
                }
		...
		private static async Task<int> CountWhereSelectMany<T>(CounterPointQSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<CounterPointSales>()
		...
		private static async Task<int> CountWhereSelect<T>(CounterPointQSContext dbContext, string exp, string navExp, string navProp) where T : class
        {
            ...
            return await dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .Select(navProp).OfType<CounterPointSales>()
                .Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
                .Distinct()
                .OrderBy("InvoiceNo")
                .CountAsync()
                                                                                 ...
                                                                                 Dictionary<string, string> navExp, IEnumerable<string> includeLst = null)
        {
            try
            {
                using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
                    if ((string.IsNullOrEmpty(exp) && navExp.Count == 0) || exp == "None") return new List<CounterPointSales>();
                    ...
                    return await set//dbContext.CounterPointSales
								.AsNoTracking()
                                .Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
								.OrderBy(y => y.InvoiceNo)
		...
		private static async Task<IEnumerable<CounterPointSales>> LoadRangeWhere<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<CounterPointSales>> LoadRangeSelectMany<T>(int startIndex, int count,
		...
		private static async Task<IEnumerable<CounterPointSales>> LoadRangeSelect<T>(int startIndex, int count,
            CounterPointQSContext dbContext, string exp, string navExp, string navProp, IEnumerable<string> includeLst = null) where T : class
        {
			try
			{
        ...
        private static async Task<IEnumerable<CounterPointSales>> GetWhere<T>(CounterPointQSContext dbContext,
		...
		private static async Task<IEnumerable<CounterPointSales>> GetWhereSelectMany<T>(CounterPointQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			...
			var set = (DbQuery<CounterPointSales>)dbContext.Set<T>()
				.AsNoTracking()
                .Where(navExp)
                .SelectMany(navProp).OfType<CounterPointSales>()
                .Where(exp == "All" || exp == null?"InvoiceNo != null":exp)
		...
		private static async Task<IEnumerable<CounterPointSales>> GetWhereSelect<T>(CounterPointQSContext dbContext,
            string exp, string navExp, string navProp, List<string> includesLst = null) where T : class
        {
			try
			{
             ...
             try
             {
                 using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                 {
					decimal res = 0;
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToDecimal(dbContext.CounterPointSales.AsNoTracking().Sum(field));
                     }
                     else
                     {
                         res = Convert.ToDecimal(dbContext.CounterPointSales.AsNoTracking().Where(whereExp).Sum(field));
                     }
        ...
        public async Task<decimal> SumNav( string exp, Dictionary<string, string> navExp, string field)
        {
            try
            {
                ...
                using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                {
                    if (exp == "All" && navExp.Count == 0)
                    {
                        return Convert.ToDecimal(dbContext.CounterPointSales
										.AsNoTracking()
                                        .Sum(field)??0);
                    }
                    return Convert.ToDecimal(dbContext.CounterPointSales.Where(exp == "All" || exp == null ? "InvoiceNo != null" : exp)
											.AsNoTracking()
                                            .Sum(field)??0);
                }
             ...
             try
             {
                 using (var dbContext = new CounterPointQSContext(){StartTracking = StartTracking})
                 {
					string res = "";
                     ...
                     if (whereExp == "All")
                     {
                          res = Convert.ToString(dbContext.CounterPointSales.AsNoTracking().Min(field));
                     }
                     else
                     {
                         res = Convert.ToString(dbContext.CounterPointSales.AsNoTracking().Where(whereExp).Min(field));
                     }
		...
		private static IQueryable<CounterPointSales> AddIncludes(IEnumerable<string> includesLst, CounterPointQSContext dbContext)
       {
		 try
			{
			   if (includesLst == null) includesLst = new List<string>();
			   var set =(DbQuery<CounterPointSales>) dbContext.CounterPointSales; 
	   ...
	   private IQueryable<CounterPointSales> AddWheres(List<string> expLst, IQueryable<CounterPointSales> set)
        {
            try
            {
