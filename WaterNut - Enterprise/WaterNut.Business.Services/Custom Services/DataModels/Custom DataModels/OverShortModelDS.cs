...
//                {
//                    var s = new OverShortSuggestedDocument(true)
//                    {
//                        OversShortsId = os,
...
//        internal async Task<IEnumerable<OversShortEX>> GetOverShortEx(IEnumerable<int> slst)
//        {
...
//                    {
//                        "OverShort"
//                    }).ConfigureAwait(false)).GroupBy(x => x.OversShortEX).ToList();
//                }
//            }
//            else
//            {
...
//                    {
//                        lst.Add(
//                            (await ctx.GetOverShortDetailsByExpression(string.Format("OverShortId == {0} && ReceivedQty < InvoiceQty", o), new List<string>()
//                            {
//                                "OverShort"
//                            }).ConfigureAwait(false)).GroupBy(x => x.OversShortEX).FirstOrDefault());
//                    }
//                }
...
//                var osa = new OverShortDetailAllocation(true)
//                {
//                    Item_Id = ai.Item_Id,
...
//                {
//                    await ctx.DeleteOversShort(item.ToString()).ConfigureAwait(false);
...
//                    foreach (var o in slst)
//                    {
//                        var alst = await ctx.GetOverShortDetailsByExpressionNav(string.Format("OverShortId == {0} && ReceivedQty < InvoiceQty", o),
//                        new Dictionary<string, string>()
//                        {
//                            {
//                                "OversShortEX",
...
//        internal async Task MatchToCurrentItem(int currentDocumentItem, OverShortDetailsEX osd)
//        {
...
//                return
//                    await
//                        ctx.GetAsycudaDocumentItemByKey(currentDocumentItem
...
//        private async Task DeleteOverShortDetail(int osd)
//        {
//            using (var ctx = new OverShortDetailService())
//            {
//                await ctx.DeleteOverShortDetail(osd.ToString()).ConfigureAwait(false);
//            }
//        }
...
//                    if (await CreateEx9Class.Instance.CreateEx9EntryAsync(pod, cdoc, itmcount, dfp, ApplyEX9Bucket).ConfigureAwait(false))
//                    {
...
//            {
//                slst.Append(string.Format("{0},", os));
//            }
//            RemoveComma(slst);
//            slst.Append(")");
//            return slst;
