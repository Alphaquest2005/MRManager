...
namespace OversShortQS.Business.Services
{
    ...
    public partial interface IOverShortDetailService : IBusinessService
    {
        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<OverShortDetail>> GetOverShortDetails(List<string> includesLst = null, bool tracking = true);

        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<OverShortDetail> GetOverShortDetailByKey(string id, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<OverShortDetail>> GetOverShortDetailsByExpression(string exp, List<string> includesLst = null, bool tracking = true);

		[OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<OverShortDetail>> GetOverShortDetailsByExpressionLst(List<string> expLst, List<string> includesLst = null, bool tracking = true);
        ...
        [OperationContract]
        [FaultContract(typeof(ValidationFault))]
        Task<IEnumerable<OverShortDetail>> GetOverShortDetailsByBatchExpressionLst(List<string> exp,
            int totalrow, List<string> includesLst = null, bool tracking = true);
