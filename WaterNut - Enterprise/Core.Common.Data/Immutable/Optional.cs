...
namespace Core.Common.Data.Immutable
{
    ...
    public struct Optional<T>
    {
        ...
        {
            [DebuggerStepThrough] get { return new Optional<T>(); }
        }
        ...
        {
            [DebuggerStepThrough] get { return this.isDefined; }
        }
        ...
        public T Value
        {
            [DebuggerStepThrough] get { return this.value; }
        }
