namespace DocumentDS.Business.Entities.Mapping
{
    ...
    public partial class xcuda_TradersMap : EntityTypeConfiguration<xcuda_Traders>
    {
        ...
        {                        
              ...
              this.HasOptional(t => t.xcuda_Consignee).WithRequired(t => t.xcuda_Traders);
              this.HasOptional(t => t.xcuda_Exporter).WithRequired(t => t.xcuda_Traders);
              this.HasOptional(t => t.xcuda_Traders_Financial).WithRequired(t => t.xcuda_Traders);
             // Tracking Properties
