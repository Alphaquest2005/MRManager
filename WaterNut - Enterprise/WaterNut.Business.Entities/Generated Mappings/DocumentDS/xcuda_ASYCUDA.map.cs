namespace DocumentDS.Business.Entities.Mapping
{
    ...
    public partial class xcuda_ASYCUDAMap : EntityTypeConfiguration<xcuda_ASYCUDA>
    {
        ...
        {                        
              ...
              this.HasOptional(t => t.xcuda_Declarant).WithRequired(t => t.xcuda_ASYCUDA);
              ...
              this.HasOptional(t => t.xcuda_General_information).WithRequired(t => t.xcuda_ASYCUDA);
              this.HasMany(t => t.xcuda_Global_taxes).WithOptional(t => t.xcuda_ASYCUDA).HasForeignKey(d => d.ASYCUDA_Id);
              this.HasOptional(t => t.xcuda_Identification).WithRequired(t => t.xcuda_ASYCUDA);
              this.HasOptional(t => t.xcuda_Property).WithRequired(t => t.xcuda_ASYCUDA);
              ...
              this.HasOptional(t => t.xcuda_Valuation).WithRequired(t => t.xcuda_ASYCUDA);
              this.HasMany(t => t.xcuda_Warehouse).WithOptional(t => t.xcuda_ASYCUDA).HasForeignKey(d => d.ASYCUDA_Id);
              this.HasOptional(t => t.xcuda_ASYCUDA_ExtendedProperties).WithRequired(t => t.xcuda_ASYCUDA);
              this.HasOptional(t => t.xcuda_Traders).WithRequired(t => t.xcuda_ASYCUDA);
              this.HasOptional(t => t.Ex).WithRequired(t => t.xcuda_ASYCUDA);
              this.HasMany(t => t.AsycudaDocumentEntryDatas).WithRequired(t => t.xcuda_ASYCUDA);
             // Tracking Properties
