namespace InventoryDS.Business.Entities.Mapping
{
    ...
    public partial class TariffCodeMap : EntityTypeConfiguration<TariffCode>
    {
        public TariffCodeMap()
        {                        
              this.HasKey(t => t.TariffCodeName);        
              this.ToTable("TariffCodes");
              this.Property(t => t.TariffCodeName).HasColumnName("TariffCode").IsRequired().IsUnicode(false).HasMaxLength(8);
