namespace AllocationDS.Business.Entities.Mapping
{
    ...
    public partial class EntryPreviousItemsMap : EntityTypeConfiguration<EntryPreviousItems>
    {
        ...
        {                        
              ...
              this.HasRequired(t => t.xcuda_Item).WithMany(t => t.EntryPreviousItems).HasForeignKey(d => d.Item_Id);
              this.HasRequired(t => t.xcuda_PreviousItem).WithMany(t => t.EntryPreviousItems).HasForeignKey(d => d.PreviousItem_Id);
             // Tracking Properties
