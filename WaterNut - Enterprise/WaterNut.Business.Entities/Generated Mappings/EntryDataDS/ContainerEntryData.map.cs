namespace EntryDataDS.Business.Entities.Mapping
{
    ...
    public partial class ContainerEntryDataMap : EntityTypeConfiguration<ContainerEntryData>
    {
        ...
        {                        
              ...
              this.HasRequired(t => t.Container).WithMany(t => t.ContainerEntryData).HasForeignKey(d => d.Container_Id);
              this.HasRequired(t => t.EntryData).WithMany(t => t.ContainerEntryData).HasForeignKey(d => d.EntryDataId);
             // Tracking Properties
