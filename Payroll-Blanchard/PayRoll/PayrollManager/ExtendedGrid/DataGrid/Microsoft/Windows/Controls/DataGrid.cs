...
using ExtendedGrid.Microsoft.Windows.Automation.Peers;
using ExtendedGrid.Microsoft.Windows.Controls.Primitives;
using DoubleUtil = MS.Internal.DoubleUtil;
...
namespace ExtendedGrid.Microsoft.Windows.Controls
{
    ...
    public class DataGrid : MultiSelector
    {
        ...
        public List<DataGridColumn> ColumnsInGroupBy =new List<DataGridColumn>(); 

        public bool IsGroupByColumnAdded
        {
            get {
                return GroupByColumnAdded != null;
            }
        }
        ...
        /// </summary>
        protected static void OnNotifyRowHeaderPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
        ...
        /// </summary>
        protected static void OnNotifyRowHeaderWidthPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
        ...
        private static void OnCurrentCellChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (dataGrid.PreviouseSelectedDataCell != null)
                dataGrid.PreviouseSelectedDataCell.RowOwner.IsCurrent = false;
            if (dataGrid.CurrentCellContainer!=null)
                dataGrid.CurrentCellContainer.RowOwner.IsCurrent = true;
            dataGrid.PreviouseSelectedDataCell = dataGrid.CurrentCellContainer;


            dataGrid.OnCurrentCellChanged(EventArgs.Empty);
        }

         DataGridCell PreviouseSelectedDataCell { get; set; }
        ...
        {
            return new ExtendedGrid.Microsoft.Windows.Automation.Peers.DataGridAutomationPeer(this);
        }
