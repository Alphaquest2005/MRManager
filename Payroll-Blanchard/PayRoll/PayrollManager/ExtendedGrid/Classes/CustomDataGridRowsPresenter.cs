...
namespace ExtendedGrid.Classes
{
    public class CustomDataGridRowsPresenter : DataGridRowsPresenter
    {
        ...
        protected override void OnViewportOffsetChanged(Vector oldViewportOffset, Vector newViewportOffset)
        {
            ...
            {
                Base.CustomDataGrid dataGrid = Owner;
                if (dataGrid != null)
                {
        ...
        private Base.CustomDataGrid Owner
        {
            get { return _owner ?? (_owner = ItemsControl.GetItemsOwner(this) as Base.CustomDataGrid); }
        }
        ...
        private Base.CustomDataGrid _owner;
