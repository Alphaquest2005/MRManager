...
namespace LinqLib.Sequence
{
  ...
  public static class SpecializedSets
  {
    ...
    /// </summary>
    static long[] powersOfTen = new long[] { 1, 10, 100, 1000, 
                                             10000, 
                                             100000, 
                                             1000000, 
                                             10000000, 
    ...
    {
      return SumOfDigits(value.ToString());
    }
    ...
    {
      Helper.InvalidateNullParam(digits, "digits");
