...
namespace LinqLib.Sequence
{
  ...
  public static class Combinatorics
  {
    ...
    {
      Helper.InvalidateNullParam(pool, "pool");
    ...
    private static void GetNextPermutation(int[] idxs, int selectionSize, int poolSize)
    {
    ...
    private static void GetNextUniquePermutation(int[] idxs, int selectionSize, int poolSize)
    {
    ...
    private static void GetNextCombination(int[] idxs, int selectionSize, int poolSize)
    {
      int position = selectionSize - 1;
    ...
    private static void GetNextUniqueCombination(int[] idxs, int selectionSize, int poolSize)
    {
      int position = selectionSize - 1;
      int offset = 0;
    ...
    private static IEnumerable<T> GetItems<T>(T[] items, int[] idxs, int length)
    {
