...
namespace LinqLib.Sequence
{
  ...
  public class AlignResult<TLeft, TRight> : MatchResult<TLeft, TRight>
  {
    ...
    public AlignResult(TLeft leftItem, TRight rightItem)
      : this(leftItem, rightItem, Sequence.AlignType.Match)
    { }
    ...
    public override bool Equals(object obj)
    {
      ...
      return (base.Equals(other) && this.AlignType.Equals(other.AlignType));
    }
    ...
    {
      return base.GetHashCode() ^ this.AlignType.GetHashCode();
    }
  }
}
