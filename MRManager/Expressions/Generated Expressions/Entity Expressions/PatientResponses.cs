...
// Get Leaf Properties
		...
		public static IQueryable<Cities> GetCities(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressCities().Cities();
    
		public static IQueryable<AddressCities> GetAddressCities(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressCities();
		...
		public static IQueryable<AddressCountries> GetAddressCountries(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressCountries();
    
		public static IQueryable<AddressLines> GetAddressLines(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressLines();
    
		public static IQueryable<Parishes> GetParishes(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressParishes().Parishes();
    
		public static IQueryable<AddressParishes> GetAddressParishes(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressParishes();
    
		public static IQueryable<States> GetStates(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressStates().States();
    
		public static IQueryable<AddressStates> GetAddressStates(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressStates();
    
		public static IQueryable<ZipCodes> GetZipCodes(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressZipCodes().ZipCodes();
    
		public static IQueryable<AddressZipCodes> GetAddressZipCodes(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().AddressZipCodes();
    
		public static IQueryable<AddressTypes> GetAddressTypes(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().AddressTypes();
		...
		public static IQueryable<PatientDoctor> GetPatientDoctor(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().PatientDoctor();
		...
		public static IQueryable<PhoneTypes> GetPhoneTypes(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonPhoneNumbers().PhoneTypes();
		...
		public static IQueryable<OrganisationAddress> GetOrganisationAddress(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses().OrganisationAddress();
    
		public static IQueryable<Addresses> GetAddresses(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().Addresses();
    
		public static IQueryable<PrimaryPersonAddress> GetPrimaryPersonAddress(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses().PrimaryPersonAddress();
    
		public static IQueryable<PersonAddresses> GetPersonAddresses(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonAddresses();
    
		public static IQueryable<PersonEmailAddress> GetPersonEmailAddress(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonEmailAddress();
		...
		public static IQueryable<PersonNames> GetPersonNames(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonNames();
    
		public static IQueryable<PrimaryPersonPhoneNumber> GetPrimaryPersonPhoneNumber(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonPhoneNumbers().PrimaryPersonPhoneNumber();
    
		public static IQueryable<PersonPhoneNumbers> GetPersonPhoneNumbers(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons().PersonPhoneNumbers();
		...
		public static IQueryable<Persons> GetPersons(this IQueryable<PatientResponses> query) => query.PatientVisit().Persons_Doctor().Persons();
