		...
		private static void CreateSeedData()
		{
				...
				Instance.Database.ExecuteSqlCommand(@"
					SET IDENTITY_INSERT dbo.Organisations ON
						Insert Into dbo.Organisations (Id,Name,EntryTimeStamp,VATNumber) Values('0','Unspecified',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61355) as varbinary(max)),'0')
						Insert Into dbo.Organisations (Id,Name,EntryTimeStamp,VATNumber) Values('2','Insight Software',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61359) as varbinary(max)),'0')
						Insert Into dbo.Organisations (Id,Name,EntryTimeStamp,VATNumber) Values('3','Spice Inn Hotel',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61363) as varbinary(max)),'123')
...
");
				Instance.Database.ExecuteSqlCommand(@"
						Insert Into dbo.Persons_Patient (Id,DateOfBirth,CountryId,SexId) Values('0','1783-01-01','0','0')
						Insert Into dbo.Persons_Patient (Id,DateOfBirth,CountryId,SexId) Values('1','1980-05-17','1','1')
");
				Instance.Database.ExecuteSqlCommand(@"
			...
			//No test data for ExamDetailComponents
				Instance.Database.ExecuteSqlCommand(@"
					SET IDENTITY_INSERT dbo.Media ON
						Insert Into dbo.Media (Id,Value,MediaTypeId) Values('0',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61335) as varbinary(max)),'1')
						Insert Into dbo.Media (Id,Value,MediaTypeId) Values('6',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61331) as varbinary(max)),'1')
						Insert Into dbo.Media (Id,Value,MediaTypeId) Values('5',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61327) as varbinary(max)),'1')
						Insert Into dbo.Media (Id,Value,MediaTypeId) Values('4',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61323) as varbinary(max)),'1')
						Insert Into dbo.Media (Id,Value,MediaTypeId) Values('3',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61319) as varbinary(max)),'1')
						Insert Into dbo.Media (Id,Value,MediaTypeId) Values('2',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61315) as varbinary(max)),'2')
						Insert Into dbo.Media (Id,Value,MediaTypeId) Values('1',cast((select Value from AmoebaDB.dbo.TestValues where Id = 61311) as varbinary(max)),'1')
				...
				Instance.Database.ExecuteSqlCommand(@"
					SET IDENTITY_INSERT Interview.Questions ON
						Insert Into Interview.Questions (InterviewId,Id,Description) Values('1003','26','Are you under a physicians care or have you been during the past 5 years, including hospitalization, and surgery?')
						Insert Into Interview.Questions (InterviewId,Id,Description) Values('3','25','Is the symptom/problem getting better or worse?')
						Insert Into Interview.Questions (InterviewId,Id,Description) Values('3','24','Have you ever been treated for this complaint?')
						Insert Into Interview.Questions (InterviewId,Id,Description) Values('3','23','How does this problem interfere with your work or other activities? ')
						Insert Into Interview.Questions (InterviewId,Id,Description) Values('3','22','Is this symptom/problem constant or occasional?')
						Insert Into Interview.Questions (InterviewId,Id,Description) Values('3','21','When was the onset?')
						Insert Into Interview.Questions (InterviewId,Id,Description) Values('3','20','Which Eye?')
						Insert Into Interview.Questions (InterviewId,Id,Description) Values('3','4','Have you had any Change in vision?')
...
");
				Instance.Database.ExecuteSqlCommand(@"
					SET IDENTITY_INSERT dbo.PatientDoctor ON
						Insert Into dbo.PatientDoctor (Id,PatientId,DoctorId) Values('1','0','0')
						Insert Into dbo.PatientDoctor (Id,PatientId,DoctorId) Values('2','1','1001')
...
");
				Instance.Database.ExecuteSqlCommand(@"
						Insert Into dbo.UserSignIn (Id,Username,Password) Values('0','joe','test')
");
				Instance.Database.ExecuteSqlCommand(@"
