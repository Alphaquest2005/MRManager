...
//		{
//			EventMessageBus.Current.GetEvent<EntitySetLoaded<T>>(Source).Subscribe(x => HandleEntitySetUpdated(x.Entities));
//			EventMessageBus.Current.GetEvent<ServiceStarted<LoadEntityView<T>>>(Source)
