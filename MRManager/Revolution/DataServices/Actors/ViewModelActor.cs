    ...
    public class ViewModelActor : BaseActor<ViewModelActor>, IViewModelService
    {
        ...
        public void LoadEntityViewModel<TViewModel>(LoadViewModel vmInfo) where TViewModel:IViewModel 
        {
            try
            {
                ...
                var vm =(TViewModel) Activator.CreateInstance( concreteVM, new object[] {vmInfo.Process,vmInfo.ViewModelInfo.ViewInfo, vmInfo.ViewModelInfo.Subscriptions, vmInfo.ViewModelInfo.Publications, vmInfo.ViewModelInfo.Commands, vmInfo.ViewModelInfo.Orientation });
