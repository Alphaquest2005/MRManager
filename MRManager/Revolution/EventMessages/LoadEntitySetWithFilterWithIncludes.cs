...
namespace EventMessages
{
    public class LoadEntitySetWithFilterWithIncludes<T> : ProcessSystemMessage where T : IEntity
    {
        ...
        public LoadEntitySetWithFilterWithIncludes(List<Expression<Func<T,bool>>> filter, List<Expression<Func<T, dynamic>>> includes, ISystemProcess process, ISystemMessage msg) : base(process, msg)
        {
