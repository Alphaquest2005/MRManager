...
{
    public sealed class VirtualListItem<T> : VirtualListItemBase, INotifyPropertyChanged where T : IEntity
    {
        ...
        internal VirtualListItem(VirtualList<T> list, int index)
        {
            ...
            _list = list;
            BindingOperations.EnableCollectionSynchronization(_list, lockObject);
