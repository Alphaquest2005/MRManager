...
namespace RevolutionEntities.ViewModels
{
    ...
    {
        public EventPublication(Func<TViewModel, IObservable<dynamic>> subject, IEnumerable<Func<TViewModel, IObservable<dynamic>, bool>> subjectPredicate, IEnumerable<Func<TViewModel, dynamic>> messageData)
        {
        ...
        public IEnumerable<Func<TViewModel, IObservable<dynamic>, bool>> SubjectPredicate { get; }
