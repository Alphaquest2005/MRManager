...
namespace RevolutionEntities
{
    public sealed class NullEntity<T> : BaseEntity, IProcessSource
    {
        ...
        public ISystemSource Source => new Source(Guid.NewGuid(), "NullEntity" + typeof(NullEntity<T>).Name, new SourceType(typeof(NullEntity<T>)), new MachineInfo(Environment.MachineName, Environment.ProcessorCount));
    }
